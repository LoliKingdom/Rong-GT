...
public class Materials {
    ...
    public static FluidMaterial CarbonMonoxide = new FluidMaterial(99, "carbon_monoxide", 0xA9D0F5, MaterialIconSet.FLUID, of(new MaterialStack(Carbon, 1), new MaterialStack(Oxygen, 1)), GENERATE_PLASMA);
    ...
    public static DustMaterial SodiumSulfide = new DustMaterial(127, "sodium_sulfide", 0xAAAA00, MaterialIconSet.SAND, 1, of(new MaterialStack(Sodium, 2), new MaterialStack(Sulfur, 1)), DECOMPOSITION_BY_ELECTROLYZING);
    ...
    public static DustMaterial Uraninite = new DustMaterial(237, "uraninite", 0x232323, MaterialIconSet.ROUGH, 3, of(new MaterialStack(Uranium, 1), new MaterialStack(Oxygen, 2)), GENERATE_ORE | DISABLE_DECOMPOSITION);
    ...
    /**
     * Compounds, Polymers and more
     */
    public static DustMaterial Massicot = new DustMaterial(892, "massicot", 8943149, MaterialIconSet.SAND, 1, of(new MaterialStack(Materials.Lead, 1), new MaterialStack(Materials.Oxygen, 1)), Material.MatFlags.DECOMPOSITION_BY_ELECTROLYZING);
    public static DustMaterial AntimonyTrioxide = new DustMaterial(891, "antimony_trioxide", 8092544, MaterialIconSet.SAND, 1, of(new MaterialStack(Materials.Antimony, 2), new MaterialStack(Materials.Oxygen, 3)), Material.MatFlags.DECOMPOSITION_BY_ELECTROLYZING);
    public static DustMaterial Zincite = new DustMaterial(890, "zincite", 8947843, MaterialIconSet.SAND, 1, of(new MaterialStack(Materials.Zinc, 1), new MaterialStack(Materials.Oxygen, 1)), Material.MatFlags.DECOMPOSITION_BY_ELECTROLYZING);
    public static DustMaterial CobaltOxide = new DustMaterial(889, "cobalt_oxide", 3556352, MaterialIconSet.SAND, 1, of(new MaterialStack(Materials.Cobalt, 1), new MaterialStack(Materials.Oxygen, 1)), Material.MatFlags.DECOMPOSITION_BY_ELECTROLYZING);
    public static DustMaterial ArsenicTrioxide = new DustMaterial(888, "arsenic_trioxide", 15856113, MaterialIconSet.ROUGH, 1, of(new MaterialStack(Materials.Arsenic, 2), new MaterialStack(Materials.Oxygen, 3)), Material.MatFlags.DECOMPOSITION_BY_ELECTROLYZING);
    public static DustMaterial CupricOxide = new DustMaterial(887, "cupric_oxide", 526344, MaterialIconSet.SAND, 1, of(new MaterialStack(Materials.Copper, 1), new MaterialStack(Materials.Oxygen, 1)), Material.MatFlags.DECOMPOSITION_BY_ELECTROLYZING);
    public static DustMaterial Ferrosilite = new DustMaterial(886, "ferrosilite", 5256470, MaterialIconSet.SAND, 1, of(new MaterialStack(Materials.Iron, 1), new MaterialStack(Materials.Silicon, 1), new MaterialStack(Materials.Oxygen, 3)), Material.MatFlags.DECOMPOSITION_BY_ELECTROLYZING);
    public static DustMaterial Magnesia = new DustMaterial(885, "magnesia", 8943736, MaterialIconSet.SAND, 1, of(new MaterialStack(Materials.Magnesium, 1), new MaterialStack(Materials.Oxygen, 1)), Material.MatFlags.DECOMPOSITION_BY_ELECTROLYZING);

    public static DustMaterial Polydimethylsiloxane = new DustMaterial(959, "polydimethylsiloxane", 9211020, MaterialIconSet.DULL, 1, of(new MaterialStack(Materials.Carbon, 2), new MaterialStack(Materials.Hydrogen, 6), new MaterialStack(Materials.Oxygen, 1), new MaterialStack(Materials.Silicon, 1)), Material.MatFlags.DECOMPOSITION_BY_ELECTROLYZING);
    public static DustMaterial SiliconeRubber = new IngotMaterial(960, "silicon_rubber", 11316396, MaterialIconSet.DULL, 1, of(new MaterialStack(Materials.Carbon, 2), new MaterialStack(Materials.Hydrogen, 6), new MaterialStack(Materials.Oxygen, 1), new MaterialStack(Materials.Silicon, 1)), DustMaterial.MatFlags.GENERATE_PLATE | SolidMaterial.MatFlags.GENERATE_GEAR | IngotMaterial.MatFlags.GENERATE_RING | Material.MatFlags.FLAMMABLE | DustMaterial.MatFlags.NO_SMASHING | IngotMaterial.MatFlags.GENERATE_FOIL);
    public static FluidMaterial Dimethyldichlorosilane = new FluidMaterial(958, "dimethyldichlorosilane", 4070471, MaterialIconSet.FLUID, of(new MaterialStack(Materials.Carbon, 2), new MaterialStack(Materials.Hydrogen, 6), new MaterialStack(Materials.Chlorine, 2), new MaterialStack(Materials.Silicon, 1)), FluidMaterial.MatFlags.GENERATE_FLUID_BLOCK | Material.MatFlags.DECOMPOSITION_BY_ELECTROLYZING);
    public static FluidMaterial Styrene = new FluidMaterial(957, "styrene", 10722453, MaterialIconSet.FLUID, of(new MaterialStack(Materials.Carbon, 8), new MaterialStack(Materials.Hydrogen, 8)), FluidMaterial.MatFlags.GENERATE_FLUID_BLOCK | Material.MatFlags.DECOMPOSITION_BY_ELECTROLYZING);
    public static DustMaterial Polystyrene = new IngotMaterial(956, "polystyrene", 8945785, MaterialIconSet.DULL, 1, of(new MaterialStack(Materials.Carbon, 8), new MaterialStack(Materials.Hydrogen, 8)), Material.MatFlags.DISABLE_DECOMPOSITION | IngotMaterial.MatFlags.GENERATE_FOIL);
    public static FluidMaterial Butadiene = new FluidMaterial(955, "butadiene", 11885072, MaterialIconSet.GAS, of(new MaterialStack(Materials.Carbon, 4), new MaterialStack(Materials.Hydrogen, 6)), FluidMaterial.MatFlags.GENERATE_FLUID_BLOCK | Material.MatFlags.DECOMPOSITION_BY_ELECTROLYZING);
    public static DustMaterial RawStyreneButadieneRubber = new DustMaterial(954, "raw_styrene_butadiene_rubber", 5192762, MaterialIconSet.SAND, 1, of(new MaterialStack(Materials.Carbon, 8), new MaterialStack(Materials.Hydrogen, 8), new MaterialStack(Materials.Butadiene, 3)), Material.MatFlags.DISABLE_DECOMPOSITION);
    public static DustMaterial StyreneButadieneRubber = new IngotMaterial(953, "styrene_butadiene_rubber", 1906453, MaterialIconSet.ROUGH, 1, of(new MaterialStack(Materials.Carbon, 8), new MaterialStack(Materials.Hydrogen, 8), new MaterialStack(Materials.Butadiene, 3)), DustMaterial.MatFlags.GENERATE_PLATE | SolidMaterial.MatFlags.GENERATE_GEAR | IngotMaterial.MatFlags.GENERATE_RING | Material.MatFlags.FLAMMABLE | DustMaterial.MatFlags.NO_SMASHING);
    public static FluidMaterial Dichlorobenzene = new FluidMaterial(952, "dichlorobenzene", 868171, MaterialIconSet.FLUID, of(new MaterialStack(Materials.Carbon, 6), new MaterialStack(Materials.Hydrogen, 4), new MaterialStack(Materials.Chlorine, 2)), FluidMaterial.MatFlags.GENERATE_FLUID_BLOCK | Material.MatFlags.DECOMPOSITION_BY_ELECTROLYZING);
    public static FluidMaterial Isoprene = new FluidMaterial(893, "isoprene", 1907997, MaterialIconSet.FLUID, of(new MaterialStack(Materials.Carbon, 5), new MaterialStack(Materials.Hydrogen, 8)), FluidMaterial.MatFlags.GENERATE_FLUID_BLOCK | Material.MatFlags.DECOMPOSITION_BY_ELECTROLYZING);
    public static IngotMaterial PolyphenyleneSulfide = new IngotMaterial(934, "polyphenylene_sulfide", 8743424, MaterialIconSet.DULL, 1, of(new MaterialStack(Materials.Carbon, 6), new MaterialStack(Materials.Hydrogen, 4), new MaterialStack(Materials.Sulfur, 1)), Material.MatFlags.DISABLE_DECOMPOSITION | EXT_METAL | IngotMaterial.MatFlags.GENERATE_FOIL, (Element) null, 6.0F, 32);
    public static FluidMaterial NickelSulfateSolution = new FluidMaterial(933, "nickel_sulfate_water_solution", 4109888, MaterialIconSet.FLUID, of(), FluidMaterial.MatFlags.GENERATE_FLUID_BLOCK | Material.MatFlags.DISABLE_DECOMPOSITION);
    public static FluidMaterial BlueVitriolSolution = new FluidMaterial(932, "blue_vitriol_water_solution", 4761024, MaterialIconSet.FLUID, of(), FluidMaterial.MatFlags.GENERATE_FLUID_BLOCK | Material.MatFlags.DISABLE_DECOMPOSITION);
    public static DustMaterial PhosphorousPentoxide = new DustMaterial(996, "phosphorous_pentoxide", 8158464, MaterialIconSet.DULL, 1, of(new MaterialStack(Materials.Phosphorus, 4), new MaterialStack(Materials.Oxygen, 10)), Material.MatFlags.DECOMPOSITION_BY_ELECTROLYZING);
    public static FluidMaterial PhosphoricAcid = new FluidMaterial(995, "phosphoric_acid", 11447824, MaterialIconSet.FLUID, of(new MaterialStack(Materials.Hydrogen, 3), new MaterialStack(Materials.Phosphorus, 4)), FluidMaterial.MatFlags.GENERATE_FLUID_BLOCK | Material.MatFlags.DECOMPOSITION_BY_ELECTROLYZING);
    public static FluidMaterial PolyvinylAcetate = new FluidMaterial(994, "polyvinyl_acetate", 13139532, MaterialIconSet.FLUID, of(new MaterialStack(Materials.Carbon, 4), new MaterialStack(Materials.Hydrogen, 6), new MaterialStack(Materials.Oxygen, 2)), FluidMaterial.MatFlags.GENERATE_FLUID_BLOCK);
    public static FluidMaterial Phenol = new FluidMaterial(993, "phenol", 6635559, MaterialIconSet.FLUID, of(new MaterialStack(Materials.Carbon, 6), new MaterialStack(Materials.Hydrogen, 6), new MaterialStack(Materials.Oxygen, 1)), FluidMaterial.MatFlags.GENERATE_FLUID_BLOCK | Material.MatFlags.DECOMPOSITION_BY_ELECTROLYZING);
    public static IngotMaterial ReinforcedEpoxyResin = new IngotMaterial(991, "reinforced_epoxy_resin", 7491595, MaterialIconSet.DULL, 1, of(new MaterialStack(Materials.Carbon, 6), new MaterialStack(Materials.Hydrogen, 4), new MaterialStack(Materials.Oxygen, 1)), DustMaterial.MatFlags.GENERATE_PLATE, (Element) null, 6.0F, 64);
    public static IngotMaterial BorosilicateGlass = new IngotMaterial(990, "borosilicate_glass", 13424588, MaterialIconSet.METALLIC, 1, of(new MaterialStack(Materials.Boron, 1), new MaterialStack(Materials.SiliconDioxide, 7)), Material.MatFlags.DECOMPOSITION_BY_CENTRIFUGING);
    public static IngotMaterial PolyvinylChloride = new IngotMaterial(989, "polyvinyl_chloride", 10069156, MaterialIconSet.DULL, 1, of(new MaterialStack(Materials.Carbon, 2), new MaterialStack(Materials.Hydrogen, 3), new MaterialStack(Materials.Chlorine, 1)), EXT_METAL | IngotMaterial.MatFlags.GENERATE_FOIL);
    public static FluidMaterial VinylChloride = new FluidMaterial(988, "vinyl_chloride", 11582395, MaterialIconSet.GAS, of(new MaterialStack(Materials.Carbon, 2), new MaterialStack(Materials.Hydrogen, 3), new MaterialStack(Materials.Chlorine, 1)), FluidMaterial.MatFlags.STATE_GAS | Material.MatFlags.DECOMPOSITION_BY_ELECTROLYZING);
    public static FluidMaterial Cumene = new FluidMaterial(925, "cumene", 4924684, MaterialIconSet.FLUID, of(new MaterialStack(Materials.Carbon, 9), new MaterialStack(Materials.Hydrogen, 12)), FluidMaterial.MatFlags.GENERATE_FLUID_BLOCK | Material.MatFlags.DECOMPOSITION_BY_ELECTROLYZING);
    public static IngotMaterial IndiumGalliumPhosphide = new IngotMaterial(924, "indium_gallium_phosphide", 8220052, MaterialIconSet.DULL, 1, of(new MaterialStack(Materials.Indium, 1), new MaterialStack(Materials.Gallium, 1), new MaterialStack(Materials.Phosphorus, 1)), Material.MatFlags.DECOMPOSITION_BY_CENTRIFUGING | DustMaterial.MatFlags.GENERATE_PLATE);
    public static DustMaterial PlatinumGroupSludge = new DustMaterial(923, "platinum_group_sludge", 4864, MaterialIconSet.POWDER, 1, of(), Material.MatFlags.DISABLE_DECOMPOSITION);
    public static DustMaterial FerriteMixture = new DustMaterial(922, "ferrite_mixture", 9803157, MaterialIconSet.METALLIC, 1, of(new MaterialStack(Materials.Nickel, 1), new MaterialStack(Materials.Zinc, 1), new MaterialStack(Materials.Iron, 4)), Material.MatFlags.DISABLE_DECOMPOSITION);
    public static IngotMaterial NickelZincFerrite = new IngotMaterial(921, "nickel_zinc_ferrite", 3092271, MaterialIconSet.METALLIC, 0, of(new MaterialStack(Materials.Nickel, 1), new MaterialStack(Materials.Zinc, 1), new MaterialStack(Materials.Iron, 4), new MaterialStack(Materials.Oxygen, 8)), EXT_METAL, (Element) null, 1500);
    public static FluidMaterial IndiumConcentrate = new FluidMaterial(920, "indium_concentrate", 205130, MaterialIconSet.FLUID, of(), FluidMaterial.MatFlags.GENERATE_FLUID_BLOCK | Material.MatFlags.DISABLE_DECOMPOSITION);
    public static FluidMaterial LeadZincSolution = new FluidMaterial(919, "lead_zinc_solution", 3213570, MaterialIconSet.FLUID, of(new MaterialStack(Materials.Lead, 1), new MaterialStack(Materials.Silver, 1), new MaterialStack(Materials.Zinc, 1), new MaterialStack(Materials.Sulfur, 3), new MaterialStack(Materials.Water, 1)), FluidMaterial.MatFlags.GENERATE_FLUID_BLOCK | Material.MatFlags.DECOMPOSITION_BY_ELECTROLYZING);
    public static FluidMaterial Tetrafluoroethylene = new FluidMaterial(918, "tetrafluoroethylene", 6776679, MaterialIconSet.GAS, of(new MaterialStack(Materials.Carbon, 2), new MaterialStack(Materials.Fluorine, 4)), FluidMaterial.MatFlags.STATE_GAS | Material.MatFlags.DECOMPOSITION_BY_ELECTROLYZING);
    public static FluidMaterial SaltWater = new FluidMaterial(917, "salt_water", 255, MaterialIconSet.FLUID, of(), FluidMaterial.MatFlags.GENERATE_FLUID_BLOCK);
    public static FluidMaterial Benzene = new FluidMaterial(985, "benzene", 2039583, MaterialIconSet.FLUID, of(new MaterialStack(Materials.Carbon, 6), new MaterialStack(Materials.Hydrogen, 6)), FluidMaterial.MatFlags.GENERATE_FLUID_BLOCK | Material.MatFlags.DECOMPOSITION_BY_ELECTROLYZING);

    /**
     * Cracked Fluids
     */
    public static FluidMaterial HydroCrackedEthane = new FluidMaterial(916, "hydrocracked_ethane", 9868988, MaterialIconSet.FLUID, of(), FluidMaterial.MatFlags.GENERATE_FLUID_BLOCK);
    public static FluidMaterial HydroCrackedEthylene = new FluidMaterial(915, "hydrocracked_ethylene", 10724256, MaterialIconSet.GAS, of(), FluidMaterial.MatFlags.STATE_GAS);
    public static FluidMaterial HydroCrackedPropene = new FluidMaterial(914, "hydrocracked_propene", 12494144, MaterialIconSet.FLUID, of(), FluidMaterial.MatFlags.GENERATE_FLUID_BLOCK);
    public static FluidMaterial HydroCrackedPropane = new FluidMaterial(913, "hydrocracked_propane", 12494144, MaterialIconSet.FLUID, of(), FluidMaterial.MatFlags.GENERATE_FLUID_BLOCK);
    public static FluidMaterial HydroCrackedLightFuel = new FluidMaterial(912, "hydrocracked_light_fuel", 12037896, MaterialIconSet.FLUID, of(), FluidMaterial.MatFlags.GENERATE_FLUID_BLOCK);
    public static FluidMaterial HydroCrackedButane = new FluidMaterial(911, "hydrocracked_butane", 8727576, MaterialIconSet.FLUID, of(), FluidMaterial.MatFlags.GENERATE_FLUID_BLOCK);
    public static FluidMaterial HydroCrackedNaphtha = new FluidMaterial(910, "hydrocracked_naphtha", 12563976, MaterialIconSet.FLUID, of(), FluidMaterial.MatFlags.GENERATE_FLUID_BLOCK);
    public static FluidMaterial HydroCrackedHeavyFuel = new FluidMaterial(909, "hydrocracked_heavy_fuel", 16776960, MaterialIconSet.FLUID, of(), FluidMaterial.MatFlags.GENERATE_FLUID_BLOCK);
    public static FluidMaterial HydroCrackedGas = new FluidMaterial(908, "hydrocracked_gas", 11842740, MaterialIconSet.FLUID, of(), FluidMaterial.MatFlags.GENERATE_FLUID_BLOCK);
    public static FluidMaterial HydroCrackedButene = new FluidMaterial(907, "hydrocracked_butene", 10042885, MaterialIconSet.FLUID, of(), FluidMaterial.MatFlags.GENERATE_FLUID_BLOCK);
    public static FluidMaterial HydroCrackedButadiene = new FluidMaterial(906, "hydrocracked_butadiene", 11358723, MaterialIconSet.FLUID, of(), FluidMaterial.MatFlags.GENERATE_FLUID_BLOCK);
    public static FluidMaterial SteamCrackedEthane = new FluidMaterial(905, "steamcracked_ethane", 9868988, MaterialIconSet.FLUID, of(), FluidMaterial.MatFlags.GENERATE_FLUID_BLOCK);
    public static FluidMaterial SteamCrackedEthylene = new FluidMaterial(904, "steamcracked_ethylene", 10724256, MaterialIconSet.GAS, of(), FluidMaterial.MatFlags.STATE_GAS);
    public static FluidMaterial SteamCrackedPropene = new FluidMaterial(903, "steamcracked_propene", 12494144, MaterialIconSet.FLUID, of(), FluidMaterial.MatFlags.GENERATE_FLUID_BLOCK);
    public static FluidMaterial SteamCrackedPropane = new FluidMaterial(902, "steamcracked_propane", 12494144, MaterialIconSet.FLUID, of(), FluidMaterial.MatFlags.GENERATE_FLUID_BLOCK);
    public static FluidMaterial SteamCrackedButane = new FluidMaterial(901, "steamcracked_butane", 8727576, MaterialIconSet.FLUID, of(), FluidMaterial.MatFlags.GENERATE_FLUID_BLOCK);
    public static FluidMaterial SteamCrackedNaphtha = new FluidMaterial(900, "steamcracked_naphtha", 12563976, MaterialIconSet.FLUID, of(), FluidMaterial.MatFlags.GENERATE_FLUID_BLOCK);
    public static FluidMaterial SteamCrackedGas = new FluidMaterial(899, "steamcracked_gas", 11842740, MaterialIconSet.FLUID, of(), FluidMaterial.MatFlags.GENERATE_FLUID_BLOCK);
    public static FluidMaterial SteamCrackedButene = new FluidMaterial(898, "steamcracked_butene", 10042885, MaterialIconSet.FLUID, of(), FluidMaterial.MatFlags.GENERATE_FLUID_BLOCK);
    public static FluidMaterial SteamCrackedButadiene = new FluidMaterial(897, "steamcracked_butadiene", 11358723, MaterialIconSet.FLUID, of(), FluidMaterial.MatFlags.GENERATE_FLUID_BLOCK);
    public static FluidMaterial SteamCrackedLightFuel = new FluidMaterial(145, "steam_cracked_light_fuel", 0xFFFF00, MaterialIconSet.FLUID, of(), 0);
    public static FluidMaterial SteamCrackedHeavyFuel = new FluidMaterial(146, "steam_cracked_heavy_fuel", 0xFFFF00, MaterialIconSet.FLUID, of(), 0);
