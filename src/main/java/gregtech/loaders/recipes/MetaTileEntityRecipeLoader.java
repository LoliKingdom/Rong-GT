...
public class MetaTileEntityRecipeLoader {
	...
	public static void init() {
        ...
        ModHandler.addShapedRecipe("casing_steel_turbine_casing", MetaBlocks.TURBINE_CASING.getItemVariant(STEEL_TURBINE_CASING, 3), "PhP", "PFP", "PwP", 'P', new UnificationEntry(OrePrefix.plate, Materials.Magnalium), 'F', new UnificationEntry(OrePrefix.frameGt, Materials.SoulforgedSteel));
        ...
        ModHandler.addShapedRecipe("fusion_casing", MetaBlocks.MUTLIBLOCK_CASING.getItemVariant(MultiblockCasingType.FUSION_CASING), "ThT", "THT", "TwT", 'H', MetaTileEntities.HULL[GTValues.LuV].getStackForm(), 'T', new UnificationEntry(OrePrefix.plate, Materials.Tritanium));
        ModHandler.addShapedRecipe("fusion_casing_mk2", MetaBlocks.MUTLIBLOCK_CASING.getItemVariant(MultiblockCasingType.FUSION_CASING_MK2), "EhE", "AHA", "EwE", 'H', MetaBlocks.MUTLIBLOCK_CASING.getItemVariant(MultiblockCasingType.FUSION_CASING), 'A', new UnificationEntry(OrePrefix.plate, Materials.Americium), 'E', new UnificationEntry(OrePrefix.plate, Materials.Europium));
        ...
        ModHandler.addShapedRecipe("hull_uv", MetaTileEntities.HULL[GTValues.UV].getStackForm(), "PHP", "CMC", 'M', MetaBlocks.MACHINE_CASING.getItemVariant(UV), 'C', new UnificationEntry(OrePrefix.wireGtQuadruple, Materials.NaquadahAlloy), 'H', new UnificationEntry(OrePrefix.plate, Materials.Darmstadtium), 'P', new UnificationEntry(OrePrefix.plate, Materials.Polytetrafluoroethylene));
        ...
        ModHandler.addShapedRecipe("transformer_uv", MetaTileEntities.TRANSFORMER[GTValues.UV - 1].getStackForm(), "KBB", "CM ", "KBB", 'M', MetaTileEntities.HULL[GTValues.UV].getStackForm(), 'C', new UnificationEntry(OrePrefix.wireGtQuadruple, Materials.NaquadahAlloy), 'B', new UnificationEntry(OrePrefix.cableGtSingle, Materials.Naquadah), 'K', new UnificationEntry(OrePrefix.circuit, MarkerMaterials.Tier.Ultimate));
        ...
        ModHandler.addShapedRecipe("steam_furnace_steel", MetaTileEntities.STEAM_FURNACE_STEEL.getStackForm(), "XXX", "XMX", "XFX", 'M', MetaBlocks.MACHINE_CASING.getItemVariant(STEEL_BRICKS_HULL), 'X', new UnificationEntry(OrePrefix.pipeSmall, Materials.Bronze), 'F', new ItemStack(Blocks.FURNACE));
        ...
        ModHandler.addShapedRecipe("steam_extractor_steel", MetaTileEntities.STEAM_EXTRACTOR_STEEL.getStackForm(), "XXX", "PMG", "XXX", 'M', MetaBlocks.MACHINE_CASING.getItemVariant(STEEL_HULL), 'X', new UnificationEntry(OrePrefix.pipeSmall, Materials.Steel), 'P', new ItemStack(Blocks.PISTON), 'G', new ItemStack(Blocks.GLASS));
        ...
        ModHandler.addShapedRecipe("steam_hammer_steel", MetaTileEntities.STEAM_HAMMER_STEEL.getStackForm(), "XPX", "XMX", "XAX", 'M', MetaBlocks.MACHINE_CASING.getItemVariant(STEEL_HULL), 'X', new UnificationEntry(OrePrefix.pipeSmall, Materials.Steel), 'P', new ItemStack(Blocks.PISTON), 'A', new ItemStack(Blocks.ANVIL));
        ...
        ModHandler.addShapedRecipe("steam_compressor_steel", MetaTileEntities.STEAM_COMPRESSOR_STEEL.getStackForm(), "XXX", "PMP", "XXX", 'M', MetaBlocks.MACHINE_CASING.getItemVariant(STEEL_HULL), 'X', new UnificationEntry(OrePrefix.pipeSmall, Materials.Steel), 'P', new ItemStack(Blocks.PISTON));
        ...
        ModHandler.addShapedRecipe("steam_alloy_smelter_steel", MetaTileEntities.STEAM_ALLOY_SMELTER_STEEL.getStackForm(), "XXX", "FMF", "XXX", 'M', MetaBlocks.MACHINE_CASING.getItemVariant(STEEL_BRICKS_HULL), 'X', new UnificationEntry(OrePrefix.pipeSmall, Materials.Steel), 'F', new ItemStack(Blocks.FURNACE));
        ...
        registerMachineRecipe(MetaTileEntities.RECYCLER, "PCP", "DFD", "PHP", 'P', new UnificationEntry(OrePrefix.plate, Materials.PigIron), 'C', CIRCUIT, 'F', MetaTileEntities.ELECTRIC_FURNACE[0].getStackForm(), 'H', CABLE, 'D', MOTOR);
        ...
        registerMachineRecipe(MetaTileEntities.LIGHTNING_HARVESTER, "CEF", "ETE", "FEC", 'C', CIRCUIT, 'E', BATTERY, 'T', TRANSFORMER, 'F', FIELD_GENERATOR);
