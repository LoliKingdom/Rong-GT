...
public class MachineRecipeLoader {
	...
	private static void initializeAssemblingRecipes() {
        ...
        RecipeMaps.ASSEMBLER_RECIPES.recipeBuilder().duration(480).EUt(240).input(OrePrefix.dust, Materials.Graphite, 8).input(OrePrefix.foil, Materials.Silicon, 1).fluidInputs(Materials.Glue.getFluid(250)).outputs(OreDictUnifier.get(OrePrefix.dustTiny, Materials.Graphene, 8)).buildAndRegister();
    ...
    public static void initializeFuelRecipes() {
        ...
        RecipeMaps.DISTILLATION_RECIPES.recipeBuilder().duration(120).EUt(120).fluidInputs(Materials.SteamCrackedEthane.getFluid(1000)).outputs(OreDictUnifier.get(OrePrefix.dustTiny, Materials.Carbon, 8)).fluidOutputs(Materials.Methane.getFluid(1500)).buildAndRegister();
        ...
        RecipeMaps.DISTILLATION_RECIPES.recipeBuilder().duration(180).EUt(120).fluidInputs(Materials.SteamCrackedPropene.getFluid(1000)).outputs(OreDictUnifier.get(OrePrefix.dust, Materials.Carbon, 3)).fluidOutputs(Materials.Methane.getFluid(1500)).buildAndRegister();
        ...
        RecipeMaps.DISTILLATION_RECIPES.recipeBuilder().duration(240).EUt(120).fluidInputs(Materials.SteamCrackedPropane.getFluid(2000)).outputs(OreDictUnifier.get(OrePrefix.dustTiny, Materials.Carbon, 12)).fluidOutputs(Materials.Ethylene.getFluid(500), Materials.Methane.getFluid(3500)).buildAndRegister();
        ...
        RecipeMaps.DISTILLATION_RECIPES.recipeBuilder().duration(240).EUt(120).fluidInputs(Materials.SteamCrackedButane.getFluid(2000)).outputs(OreDictUnifier.get(OrePrefix.dust, Materials.Carbon)).fluidOutputs(Materials.Propane.getFluid(250), Materials.Ethane.getFluid(250), Materials.Ethylene.getFluid(250), Materials.Methane.getFluid(4000)).buildAndRegister();
    ...
    public static void initializeAlloyingRecipes() {   	
    	RecipeMaps.ALLOY_SMELTER_RECIPES.recipeBuilder().duration(300).EUt(8).input(OrePrefix.dust, Materials.Iron, 9).input(OrePrefix.gem, Materials.Coke).outputs(OreDictUnifier.get(OrePrefix.block, Materials.WroughtIron)).buildAndRegister();
    	RecipeMaps.ALLOY_SMELTER_RECIPES.recipeBuilder().duration(300).EUt(8).input(OrePrefix.block, Materials.Iron).input(OrePrefix.gem, Materials.Coke).outputs(OreDictUnifier.get(OrePrefix.block, Materials.WroughtIron)).buildAndRegister();
    	RecipeMaps.ALLOY_SMELTER_RECIPES.recipeBuilder().duration(300).EUt(8).input(OrePrefix.ingot, Materials.Iron, 9).input(OrePrefix.gem, Materials.Coke).outputs(OreDictUnifier.get(OrePrefix.block, Materials.WroughtIron)).buildAndRegister();
    	RecipeMaps.ALLOY_SMELTER_RECIPES.recipeBuilder().duration(150).EUt(8).input(OrePrefix.dust, Materials.Iron, 2).input(OrePrefix.gem, Materials.Coal).outputs(OreDictUnifier.get(OrePrefix.ingot, Materials.WroughtIron, 2)).buildAndRegister();
    	RecipeMaps.ALLOY_SMELTER_RECIPES.recipeBuilder().duration(150).EUt(8).input(OrePrefix.ingot, Materials.Iron, 2).input(OrePrefix.gem, Materials.Coal).outputs(OreDictUnifier.get(OrePrefix.ingot, Materials.WroughtIron, 2)).buildAndRegister();
    	RecipeMaps.ALLOY_SMELTER_RECIPES.recipeBuilder().duration(150).EUt(8).input(OrePrefix.dust, Materials.Iron, 2).input(OrePrefix.gem, Materials.Charcoal).outputs(OreDictUnifier.get(OrePrefix.ingot, Materials.WroughtIron, 2)).buildAndRegister();
    	RecipeMaps.ALLOY_SMELTER_RECIPES.recipeBuilder().duration(150).EUt(8).input(OrePrefix.ingot, Materials.Iron, 2).input(OrePrefix.gem, Materials.Charcoal).outputs(OreDictUnifier.get(OrePrefix.ingot, Materials.WroughtIron, 2)).buildAndRegister();

    	RecipeMaps.ALLOY_SMELTER_RECIPES.recipeBuilder().duration(500).EUt(8).input(OrePrefix.dust, Materials.Obsidian, 4).notConsumable(MetaItems.SHAPE_MOLD_BLOCK).outputs(new ItemStack(Blocks.OBSIDIAN)).buildAndRegister();
    	...
    	MaterialStack[][] alloySmelterList = {
    	        ...
    	        {new MaterialStack(Materials.Bismuth, 1), new MaterialStack(Materials.Brass, 3), new MaterialStack(Materials.BismuthBronze, 4L)},
    ...
    private static void initializeBlastRecipes() {
    	RecipeMaps.BLAST_RECIPES.recipeBuilder().duration((int) Math.max(Materials.TungstenSteel.getAverageMass() / 80,1) * Materials.TungstenSteel.blastFurnaceTemperature).EUt(480).input(OrePrefix.ingot, Materials.Tungsten, 1).input(OrePrefix.ingot, Materials.Steel, 1).outputs(OreDictUnifier.get(OrePrefix.ingotHot, Materials.TungstenSteel,2), OreDictUnifier.get(OrePrefix.dustTiny, Materials.DarkAsh, 4)).blastFurnaceTemp(Materials.TungstenSteel.blastFurnaceTemperature).buildAndRegister();
        RecipeMaps.BLAST_RECIPES.recipeBuilder().duration((int) Math.max(Materials.VanadiumGallium.getAverageMass() / 40,1) * Materials.VanadiumGallium.blastFurnaceTemperature).EUt(480).input(OrePrefix.ingot, Materials.Vanadium, 3).input(OrePrefix.ingot, Materials.Gallium, 1).outputs(OreDictUnifier.get(OrePrefix.ingotHot, Materials.VanadiumGallium,4), OreDictUnifier.get(OrePrefix.dustTiny, Materials.DarkAsh, 8)).blastFurnaceTemp(Materials.VanadiumGallium.blastFurnaceTemperature).buildAndRegister();
        RecipeMaps.BLAST_RECIPES.recipeBuilder().duration((int) Math.max(Materials.NiobiumTitanium.getAverageMass() / 80,1) * Materials.NiobiumTitanium.blastFurnaceTemperature).EUt(480).input(OrePrefix.ingot, Materials.Niobium, 1).input(OrePrefix.ingot, Materials.Titanium, 1).outputs(OreDictUnifier.get(OrePrefix.ingotHot, Materials.NiobiumTitanium,2), OreDictUnifier.get(OrePrefix.dustTiny, Materials.DarkAsh, 4)).blastFurnaceTemp(Materials.NiobiumTitanium.blastFurnaceTemperature).buildAndRegister();
        RecipeMaps.BLAST_RECIPES.recipeBuilder().duration((int) Math.max(Materials.Nichrome.getAverageMass() / 32,1) * Materials.Nichrome.blastFurnaceTemperature).EUt(480).input(OrePrefix.ingot, Materials.Nickel, 4).input(OrePrefix.ingot, Materials.Chrome, 1).outputs(OreDictUnifier.get(OrePrefix.ingotHot, Materials.Nichrome,5), OreDictUnifier.get(OrePrefix.dustTiny, Materials.DarkAsh, 8)).blastFurnaceTemp(Materials.Nichrome.blastFurnaceTemperature).buildAndRegister();
        ...
        RecipeMaps.BLAST_RECIPES.recipeBuilder().duration(400).EUt(500).input(OrePrefix.dust, Materials.Magnetite, 1).fluidInputs(Materials.Oxygen.getFluid(2000)).outputs(OreDictUnifier.get(OrePrefix.nugget,Materials.WroughtIron,4), OreDictUnifier.get(OrePrefix.dustTiny,Materials.DarkAsh,4)).blastFurnaceTemp(1000).buildAndRegister();
        RecipeMaps.BLAST_RECIPES.recipeBuilder().duration(500).EUt(120).input(OrePrefix.ingot, Materials.Iron, 1).fluidInputs(Materials.Oxygen.getFluid(1000)).outputs(OreDictUnifier.get(OrePrefix.ingot,Materials.Steel,1), OreDictUnifier.get(OrePrefix.dustTiny,Materials.DarkAsh,4)).blastFurnaceTemp(1000).buildAndRegister();
        RecipeMaps.BLAST_RECIPES.recipeBuilder().duration(350).EUt(120).input(OrePrefix.ingot, Materials.PigIron, 1).fluidInputs(Materials.Oxygen.getFluid(500)).outputs(OreDictUnifier.get(OrePrefix.ingot,Materials.Steel,1), OreDictUnifier.get(OrePrefix.dustTiny,Materials.DarkAsh,4)).blastFurnaceTemp(1000).buildAndRegister();
        ...
        for(MaterialStack ore : ironOres) {
            ...
            if(targetMaterial == Materials.BandedIron) {
                RecipeMaps.BLAST_RECIPES.recipeBuilder().duration(500).EUt(90).blastFurnaceTemp(1200).input(OrePrefix.ore, targetMaterial).input(OrePrefix.dust, Materials.Calcite).outputs(OreDictUnifier.get(OrePrefix.nugget, Materials.Iron, 6), OreDictUnifier.get(OrePrefix.dustTiny, Materials.DarkAsh, 3)).buildAndRegister();
                RecipeMaps.BLAST_RECIPES.recipeBuilder().duration(500).EUt(90).blastFurnaceTemp(1200).input(OrePrefix.ore, targetMaterial).input(OrePrefix.dustTiny, Materials.Quicklime, 12).outputs(OreDictUnifier.get(OrePrefix.nugget, Materials.Iron, 8), OreDictUnifier.get(OrePrefix.dustTiny, Materials.DarkAsh, 3)).buildAndRegister();
                //RecipeMaps.BLAST_RECIPES.recipeBuilder().duration(500).EUt(90).blastFurnaceTemp(1200).input(OrePrefix.oreSand, targetMaterial).input(OrePrefix.dust, Materials.Calcite).outputs(OreDictUnifier.get(OrePrefix.nugget, Materials.Iron, 6), OreDictUnifier.get(OrePrefix.dustTiny, Materials.DarkAsh, 3)).buildAndRegister();
                //RecipeMaps.BLAST_RECIPES.recipeBuilder().duration(500).EUt(90).blastFurnaceTemp(1200).input(OrePrefix.oreSand, targetMaterial).input(OrePrefix.dustTiny, Materials.Quicklime, 12).outputs(OreDictUnifier.get(OrePrefix.nugget, Materials.Iron, 8), OreDictUnifier.get(OrePrefix.dustTiny, Materials.DarkAsh, 3)).buildAndRegister();
                RecipeMaps.BLAST_RECIPES.recipeBuilder().duration(500).EUt(90).blastFurnaceTemp(1200).input(OrePrefix.oreSandstone, targetMaterial).input(OrePrefix.dust, Materials.Calcite).outputs(OreDictUnifier.get(OrePrefix.nugget, Materials.Iron, 6), OreDictUnifier.get(OrePrefix.dustTiny, Materials.DarkAsh, 3)).buildAndRegister();
                ...
                RecipeMaps.BLAST_RECIPES.recipeBuilder().duration(500).EUt(90).blastFurnaceTemp(1200).input(OrePrefix.oreGravel, targetMaterial).input(OrePrefix.dust, Materials.Calcite).outputs(OreDictUnifier.get(OrePrefix.nugget, Materials.Iron, 6), OreDictUnifier.get(OrePrefix.dustTiny, Materials.DarkAsh, 3)).buildAndRegister();
                RecipeMaps.BLAST_RECIPES.recipeBuilder().duration(500).EUt(90).blastFurnaceTemp(1200).input(OrePrefix.oreGravel, targetMaterial).input(OrePrefix.dustTiny, Materials.Quicklime, 12).outputs(OreDictUnifier.get(OrePrefix.nugget, Materials.Iron, 8), OreDictUnifier.get(OrePrefix.dustTiny, Materials.DarkAsh, 3)).buildAndRegister();
                RecipeMaps.BLAST_RECIPES.recipeBuilder().duration(500).EUt(90).blastFurnaceTemp(1200).input(OrePrefix.oreNetherrack, targetMaterial).input(OrePrefix.dust, Materials.Calcite).outputs(OreDictUnifier.get(OrePrefix.nugget, Materials.Iron, 6), OreDictUnifier.get(OrePrefix.dustTiny, Materials.DarkAsh, 3)).buildAndRegister();
                RecipeMaps.BLAST_RECIPES.recipeBuilder().duration(500).EUt(90).blastFurnaceTemp(1200).input(OrePrefix.oreNetherrack, targetMaterial).input(OrePrefix.dustTiny, Materials.Quicklime, 12).outputs(OreDictUnifier.get(OrePrefix.nugget, Materials.Iron, 8), OreDictUnifier.get(OrePrefix.dustTiny, Materials.DarkAsh, 3)).buildAndRegister();
                RecipeMaps.BLAST_RECIPES.recipeBuilder().duration(500).EUt(90).blastFurnaceTemp(1200).input(OrePrefix.oreEndstone, targetMaterial).input(OrePrefix.dust, Materials.Calcite).outputs(OreDictUnifier.get(OrePrefix.nugget, Materials.Iron, 6), OreDictUnifier.get(OrePrefix.dustTiny, Materials.DarkAsh, 3)).buildAndRegister();
                RecipeMaps.BLAST_RECIPES.recipeBuilder().duration(500).EUt(90).blastFurnaceTemp(1200).input(OrePrefix.oreEndstone, targetMaterial).input(OrePrefix.dustTiny, Materials.Quicklime, 12).outputs(OreDictUnifier.get(OrePrefix.nugget, Materials.Iron, 8), OreDictUnifier.get(OrePrefix.dustTiny, Materials.DarkAsh, 3)).buildAndRegister();       
            }
            if((targetMaterial == Materials.Magnetite)/* || (targetMaterial == Materials.Taconite)*/) {
                RecipeMaps.BLAST_RECIPES.recipeBuilder().duration(500).EUt(90).blastFurnaceTemp(1200).input(OrePrefix.ore, targetMaterial).input(OrePrefix.dust, Materials.Calcite).outputs(OreDictUnifier.get(OrePrefix.nugget, Materials.Iron, 12), OreDictUnifier.get(OrePrefix.dustTiny, Materials.DarkAsh, 3)).buildAndRegister();
                RecipeMaps.BLAST_RECIPES.recipeBuilder().duration(500).EUt(90).blastFurnaceTemp(1200).input(OrePrefix.ore, targetMaterial).input(OrePrefix.dustTiny, Materials.Quicklime, 12).outputs(OreDictUnifier.get(OrePrefix.nugget, Materials.Iron, 16), OreDictUnifier.get(OrePrefix.dustTiny, Materials.DarkAsh, 3)).buildAndRegister();
                //RecipeMaps.BLAST_RECIPES.recipeBuilder().duration(500).EUt(90).blastFurnaceTemp(1200).input(OrePrefix.oreSand, targetMaterial).input(OrePrefix.dust, Materials.Calcite).outputs(OreDictUnifier.get(OrePrefix.nugget, Materials.Iron, 12), OreDictUnifier.get(OrePrefix.dustTiny, Materials.DarkAsh, 3)).buildAndRegister();
                //RecipeMaps.BLAST_RECIPES.recipeBuilder().duration(500).EUt(90).blastFurnaceTemp(1200).input(OrePrefix.oreSand, targetMaterial).input(OrePrefix.dustTiny, Materials.Quicklime, 12).outputs(OreDictUnifier.get(OrePrefix.nugget, Materials.Iron, 16), OreDictUnifier.get(OrePrefix.dustTiny, Materials.DarkAsh, 3)).buildAndRegister();
                RecipeMaps.BLAST_RECIPES.recipeBuilder().duration(500).EUt(90).blastFurnaceTemp(1200).input(OrePrefix.oreSandstone, targetMaterial).input(OrePrefix.dust, Materials.Calcite).outputs(OreDictUnifier.get(OrePrefix.nugget, Materials.Iron, 12), OreDictUnifier.get(OrePrefix.dustTiny, Materials.DarkAsh, 3)).buildAndRegister();
                RecipeMaps.BLAST_RECIPES.recipeBuilder().duration(500).EUt(90).blastFurnaceTemp(1200).input(OrePrefix.oreSandstone, targetMaterial).input(OrePrefix.dustTiny, Materials.Quicklime, 12).outputs(OreDictUnifier.get(OrePrefix.nugget, Materials.Iron, 16), OreDictUnifier.get(OrePrefix.dustTiny, Materials.DarkAsh, 3)).buildAndRegister();
                RecipeMaps.BLAST_RECIPES.recipeBuilder().duration(500).EUt(90).blastFurnaceTemp(1200).input(OrePrefix.oreGravel, targetMaterial).input(OrePrefix.dust, Materials.Calcite).outputs(OreDictUnifier.get(OrePrefix.nugget, Materials.Iron, 12), OreDictUnifier.get(OrePrefix.dustTiny, Materials.DarkAsh, 3)).buildAndRegister();
                RecipeMaps.BLAST_RECIPES.recipeBuilder().duration(500).EUt(90).blastFurnaceTemp(1200).input(OrePrefix.oreGravel, targetMaterial).input(OrePrefix.dustTiny, Materials.Quicklime, 12).outputs(OreDictUnifier.get(OrePrefix.nugget, Materials.Iron, 16), OreDictUnifier.get(OrePrefix.dustTiny, Materials.DarkAsh, 3)).buildAndRegister();
                RecipeMaps.BLAST_RECIPES.recipeBuilder().duration(500).EUt(90).blastFurnaceTemp(1200).input(OrePrefix.oreNetherrack, targetMaterial).input(OrePrefix.dust, Materials.Calcite).outputs(OreDictUnifier.get(OrePrefix.nugget, Materials.Iron, 12), OreDictUnifier.get(OrePrefix.dustTiny, Materials.DarkAsh, 3)).buildAndRegister();
                RecipeMaps.BLAST_RECIPES.recipeBuilder().duration(500).EUt(90).blastFurnaceTemp(1200).input(OrePrefix.oreNetherrack, targetMaterial).input(OrePrefix.dustTiny, Materials.Quicklime, 12).outputs(OreDictUnifier.get(OrePrefix.nugget, Materials.Iron, 16), OreDictUnifier.get(OrePrefix.dustTiny, Materials.DarkAsh, 3)).buildAndRegister();
                RecipeMaps.BLAST_RECIPES.recipeBuilder().duration(500).EUt(90).blastFurnaceTemp(1200).input(OrePrefix.oreEndstone, targetMaterial).input(OrePrefix.dust, Materials.Calcite).outputs(OreDictUnifier.get(OrePrefix.nugget, Materials.Iron, 12), OreDictUnifier.get(OrePrefix.dustTiny, Materials.DarkAsh, 3)).buildAndRegister();
                RecipeMaps.BLAST_RECIPES.recipeBuilder().duration(500).EUt(90).blastFurnaceTemp(1200).input(OrePrefix.oreEndstone, targetMaterial).input(OrePrefix.dustTiny, Materials.Quicklime, 12).outputs(OreDictUnifier.get(OrePrefix.nugget, Materials.Iron, 16), OreDictUnifier.get(OrePrefix.dustTiny, Materials.DarkAsh, 3)).buildAndRegister();       
            }
            if(targetMaterial == Materials.Geothite) {
                RecipeMaps.BLAST_RECIPES.recipeBuilder().duration(500).EUt(90).blastFurnaceTemp(1200).input(OrePrefix.ore, targetMaterial).input(OrePrefix.dust, Materials.Calcite).outputs(OreDictUnifier.get(OrePrefix.nugget, Materials.Iron, 17), OreDictUnifier.get(OrePrefix.dustTiny, Materials.DarkAsh, 3)).buildAndRegister();
                RecipeMaps.BLAST_RECIPES.recipeBuilder().duration(500).EUt(90).blastFurnaceTemp(1200).input(OrePrefix.ore, targetMaterial).input(OrePrefix.dustTiny, Materials.Quicklime, 12).outputs(OreDictUnifier.get(OrePrefix.nugget, Materials.Iron, 20), OreDictUnifier.get(OrePrefix.dustTiny, Materials.DarkAsh, 3)).buildAndRegister();
                //RecipeMaps.BLAST_RECIPES.recipeBuilder().duration(500).EUt(90).blastFurnaceTemp(1200).input(OrePrefix.oreSand, targetMaterial).input(OrePrefix.dust, Materials.Calcite).outputs(OreDictUnifier.get(OrePrefix.nugget, Materials.Iron, 17), OreDictUnifier.get(OrePrefix.dustTiny, Materials.DarkAsh, 3)).buildAndRegister();
                //RecipeMaps.BLAST_RECIPES.recipeBuilder().duration(500).EUt(90).blastFurnaceTemp(1200).input(OrePrefix.oreSand, targetMaterial).input(OrePrefix.dustTiny, Materials.Quicklime, 12).outputs(OreDictUnifier.get(OrePrefix.nugget, Materials.Iron, 20), OreDictUnifier.get(OrePrefix.dustTiny, Materials.DarkAsh, 3)).buildAndRegister();
                RecipeMaps.BLAST_RECIPES.recipeBuilder().duration(500).EUt(90).blastFurnaceTemp(1200).input(OrePrefix.oreSandstone, targetMaterial).input(OrePrefix.dust, Materials.Calcite).outputs(OreDictUnifier.get(OrePrefix.nugget, Materials.Iron, 17), OreDictUnifier.get(OrePrefix.dustTiny, Materials.DarkAsh, 3)).buildAndRegister();
                RecipeMaps.BLAST_RECIPES.recipeBuilder().duration(500).EUt(90).blastFurnaceTemp(1200).input(OrePrefix.oreSandstone, targetMaterial).input(OrePrefix.dustTiny, Materials.Quicklime, 12).outputs(OreDictUnifier.get(OrePrefix.nugget, Materials.Iron, 20), OreDictUnifier.get(OrePrefix.dustTiny, Materials.DarkAsh, 3)).buildAndRegister();
                RecipeMaps.BLAST_RECIPES.recipeBuilder().duration(500).EUt(90).blastFurnaceTemp(1200).input(OrePrefix.oreGravel, targetMaterial).input(OrePrefix.dust, Materials.Calcite).outputs(OreDictUnifier.get(OrePrefix.nugget, Materials.Iron, 17), OreDictUnifier.get(OrePrefix.dustTiny, Materials.DarkAsh, 3)).buildAndRegister();
                RecipeMaps.BLAST_RECIPES.recipeBuilder().duration(500).EUt(90).blastFurnaceTemp(1200).input(OrePrefix.oreGravel, targetMaterial).input(OrePrefix.dustTiny, Materials.Quicklime, 12).outputs(OreDictUnifier.get(OrePrefix.nugget, Materials.Iron, 20), OreDictUnifier.get(OrePrefix.dustTiny, Materials.DarkAsh, 3)).buildAndRegister();
                RecipeMaps.BLAST_RECIPES.recipeBuilder().duration(500).EUt(90).blastFurnaceTemp(1200).input(OrePrefix.oreNetherrack, targetMaterial).input(OrePrefix.dust, Materials.Calcite).outputs(OreDictUnifier.get(OrePrefix.nugget, Materials.Iron, 17), OreDictUnifier.get(OrePrefix.dustTiny, Materials.DarkAsh, 3)).buildAndRegister();
                RecipeMaps.BLAST_RECIPES.recipeBuilder().duration(500).EUt(90).blastFurnaceTemp(1200).input(OrePrefix.oreNetherrack, targetMaterial).input(OrePrefix.dustTiny, Materials.Quicklime, 12).outputs(OreDictUnifier.get(OrePrefix.nugget, Materials.Iron, 20), OreDictUnifier.get(OrePrefix.dustTiny, Materials.DarkAsh, 3)).buildAndRegister();
                RecipeMaps.BLAST_RECIPES.recipeBuilder().duration(500).EUt(90).blastFurnaceTemp(1200).input(OrePrefix.oreEndstone, targetMaterial).input(OrePrefix.dust, Materials.Calcite).outputs(OreDictUnifier.get(OrePrefix.nugget, Materials.Iron, 17), OreDictUnifier.get(OrePrefix.dustTiny, Materials.DarkAsh, 3)).buildAndRegister();
                RecipeMaps.BLAST_RECIPES.recipeBuilder().duration(500).EUt(90).blastFurnaceTemp(1200).input(OrePrefix.oreEndstone, targetMaterial).input(OrePrefix.dustTiny, Materials.Quicklime, 12).outputs(OreDictUnifier.get(OrePrefix.nugget, Materials.Iron, 20), OreDictUnifier.get(OrePrefix.dustTiny, Materials.DarkAsh, 3)).buildAndRegister();       
            }
            else {
                RecipeMaps.BLAST_RECIPES.recipeBuilder().duration(500).EUt(90).blastFurnaceTemp(1200).input(OrePrefix.ore, targetMaterial).input(OrePrefix.dust, Materials.Calcite).outputs(OreDictUnifier.get(OrePrefix.nugget, Materials.Iron, 25), OreDictUnifier.get(OrePrefix.dustTiny, Materials.DarkAsh, 3)).buildAndRegister();
                RecipeMaps.BLAST_RECIPES.recipeBuilder().duration(500).EUt(90).blastFurnaceTemp(1200).input(OrePrefix.ore, targetMaterial).input(OrePrefix.dustTiny, Materials.Quicklime, 12).outputs(OreDictUnifier.get(OrePrefix.nugget, Materials.Iron, 32), OreDictUnifier.get(OrePrefix.dustTiny, Materials.DarkAsh, 3)).buildAndRegister();
                //RecipeMaps.BLAST_RECIPES.recipeBuilder().duration(500).EUt(90).blastFurnaceTemp(1200).input(OrePrefix.oreSand, targetMaterial).input(OrePrefix.dust, Materials.Calcite).outputs(OreDictUnifier.get(OrePrefix.nugget, Materials.Iron, 25), OreDictUnifier.get(OrePrefix.dustTiny, Materials.DarkAsh, 3)).buildAndRegister();
                //RecipeMaps.BLAST_RECIPES.recipeBuilder().duration(500).EUt(90).blastFurnaceTemp(1200).input(OrePrefix.oreSand, targetMaterial).input(OrePrefix.dustTiny, Materials.Quicklime, 12).outputs(OreDictUnifier.get(OrePrefix.nugget, Materials.Iron, 32), OreDictUnifier.get(OrePrefix.dustTiny, Materials.DarkAsh, 3)).buildAndRegister();
                RecipeMaps.BLAST_RECIPES.recipeBuilder().duration(500).EUt(90).blastFurnaceTemp(1200).input(OrePrefix.oreSandstone, targetMaterial).input(OrePrefix.dust, Materials.Calcite).outputs(OreDictUnifier.get(OrePrefix.nugget, Materials.Iron, 25), OreDictUnifier.get(OrePrefix.dustTiny, Materials.DarkAsh, 3)).buildAndRegister();
                RecipeMaps.BLAST_RECIPES.recipeBuilder().duration(500).EUt(90).blastFurnaceTemp(1200).input(OrePrefix.oreSandstone, targetMaterial).input(OrePrefix.dustTiny, Materials.Quicklime, 12).outputs(OreDictUnifier.get(OrePrefix.nugget, Materials.Iron, 32), OreDictUnifier.get(OrePrefix.dustTiny, Materials.DarkAsh, 3)).buildAndRegister();
                RecipeMaps.BLAST_RECIPES.recipeBuilder().duration(500).EUt(90).blastFurnaceTemp(1200).input(OrePrefix.oreGravel, targetMaterial).input(OrePrefix.dust, Materials.Calcite).outputs(OreDictUnifier.get(OrePrefix.nugget, Materials.Iron, 25), OreDictUnifier.get(OrePrefix.dustTiny, Materials.DarkAsh, 3)).buildAndRegister();
                RecipeMaps.BLAST_RECIPES.recipeBuilder().duration(500).EUt(90).blastFurnaceTemp(1200).input(OrePrefix.oreGravel, targetMaterial).input(OrePrefix.dustTiny, Materials.Quicklime, 12).outputs(OreDictUnifier.get(OrePrefix.nugget, Materials.Iron, 32), OreDictUnifier.get(OrePrefix.dustTiny, Materials.DarkAsh, 3)).buildAndRegister();
                RecipeMaps.BLAST_RECIPES.recipeBuilder().duration(500).EUt(90).blastFurnaceTemp(1200).input(OrePrefix.oreNetherrack, targetMaterial).input(OrePrefix.dust, Materials.Calcite).outputs(OreDictUnifier.get(OrePrefix.nugget, Materials.Iron, 25), OreDictUnifier.get(OrePrefix.dustTiny, Materials.DarkAsh, 3)).buildAndRegister();
                RecipeMaps.BLAST_RECIPES.recipeBuilder().duration(500).EUt(90).blastFurnaceTemp(1200).input(OrePrefix.oreNetherrack, targetMaterial).input(OrePrefix.dustTiny, Materials.Quicklime, 12).outputs(OreDictUnifier.get(OrePrefix.nugget, Materials.Iron, 32), OreDictUnifier.get(OrePrefix.dustTiny, Materials.DarkAsh, 3)).buildAndRegister();
                RecipeMaps.BLAST_RECIPES.recipeBuilder().duration(500).EUt(90).blastFurnaceTemp(1200).input(OrePrefix.oreEndstone, targetMaterial).input(OrePrefix.dust, Materials.Calcite).outputs(OreDictUnifier.get(OrePrefix.nugget, Materials.Iron, 25), OreDictUnifier.get(OrePrefix.dustTiny, Materials.DarkAsh, 3)).buildAndRegister();
                RecipeMaps.BLAST_RECIPES.recipeBuilder().duration(500).EUt(90).blastFurnaceTemp(1200).input(OrePrefix.oreEndstone, targetMaterial).input(OrePrefix.dustTiny, Materials.Quicklime, 12).outputs(OreDictUnifier.get(OrePrefix.nugget, Materials.Iron, 32), OreDictUnifier.get(OrePrefix.dustTiny, Materials.DarkAsh, 3)).buildAndRegister();       
            }
        }
    }
    ...
    private static void initializeCentrifugingRecipes() {
        ...
        RecipeMaps.CENTRIFUGE_RECIPES.recipeBuilder().duration(200).EUt(20).inputs(MetaBlocks.LOG.getItem(LogVariant.RUBBER_WOOD)).chancedOutput(MetaItems.RUBBER_DROP.getStackForm(), 5000, 700).chancedOutput(OreDictUnifier.get(OrePrefix.dust, Materials.Carbon), 2500, 1000).chancedOutput(OreDictUnifier.get(OrePrefix.dust, Materials.Wood), 2500, 800).fluidOutputs(Materials.Methane.getFluid(60)).buildAndRegister();
        ...
        RecipeMaps.CENTRIFUGE_RECIPES.recipeBuilder().duration(40).EUt(220).fluidInputs(Materials.Lava.getFluid(200)).chancedOutput(OreDictUnifier.get(OrePrefix.nugget,Materials.Tantalum, 1), 1000, 1000).chancedOutput(OreDictUnifier.get(OrePrefix.dustTiny, Materials.Olivine, 1), 4000, 900).chancedOutput(OreDictUnifier.get(OrePrefix.dustTiny, Materials.Topaz, 2), 2500, 1000).chancedOutput(OreDictUnifier.get(OrePrefix.dustTiny, Materials.Tungstate, 1), 2000, 1000).chancedOutput(OreDictUnifier.get(OrePrefix.dustTiny, Materials.Spessartine, 1), 5000, 500).chancedOutput(OreDictUnifier.get(OrePrefix.dust, Materials.Zircon, 2), 100, 500).buildAndRegister();
    ...
    private static void initializeMixingRecipes() {
    	for (OrePrefix prefix : Arrays.asList(OrePrefix.dust, OrePrefix.dustTiny)) {
    ...
    private static void initializeExtractingRecipes() {
        RecipeMaps.EXTRACTOR_RECIPES.recipeBuilder().duration(128).EUt(4).inputs(new ItemStack(Items.COAL, 1, 1)).chancedOutput(OreDictUnifier.get(OrePrefix.dust,Materials.Ash, 1), 1000, 1000).fluidOutputs(Materials.Creosote.getFluid(50)).buildAndRegister();
        ...
        RecipeMaps.EXTRACTOR_RECIPES.recipeBuilder().duration(1000).EUt(24).inputs(MetaBlocks.LOG.getItem(LogVariant.RUBBER_WOOD)).chancedOutput(MetaItems.RUBBER_DROP.getStackForm(), 2500, 1000).fluidOutputs(Materials.Glue.getFluid(250)).buildAndRegister();
        RecipeMaps.EXTRACTOR_RECIPES.recipeBuilder().duration(1000).EUt(24).inputs(new ItemStack(Blocks.SANDSTONE, 1, OreDictionary.WILDCARD_VALUE)).chancedOutput(OreDictUnifier.get(OrePrefix.dust, Materials.SiliconDioxide), 3500, 500).buildAndRegister();
        RecipeMaps.EXTRACTOR_RECIPES.recipeBuilder().duration(1000).EUt(24).inputs(new ItemStack(Blocks.SAND)).chancedOutput(OreDictUnifier.get(OrePrefix.dust, Materials.SiliconDioxide), 2500, 1500).buildAndRegister();
    }
    ...
    private static void initializeMiscRecipes() {		
        ...
        RecipeMaps.CHEMICAL_BATH_RECIPES.recipeBuilder().duration(480).EUt(384).input(OrePrefix.gem, Materials.EnderEye, 2).fluidInputs(Materials.Plutonium.getFluid(L * 2)).outputs(MetaItems.QUANTUM_EYE.getStackForm()).buildAndRegister();
    ...
    private static void initializeForestrySupport() {	
    	if(Loader.isModLoaded("forestry")) {
            ...
            RecipeMaps.DISTILLATION_RECIPES.recipeBuilder().duration(32).EUt(400).fluidInputs(Materials.Biomass.getFluid(1000)).outputs(OreDictUnifier.get(OrePrefix.dustTiny, Materials.Wood, 8)).fluidOutputs(Fluids.BIO_ETHANOL.getFluid(600), Materials.Water.getFluid(300)).buildAndRegister();
