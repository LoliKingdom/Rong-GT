...
public class CraftingRecipeLoader {
    ...
    private static void loadCraftingRecipes() {
        ...
        */
        ...
        ModHandler.addShapedRecipe("mv_piston", MetaItems.ELECTRIC_PISTON_LV.getStackForm(), "PPP", "CRR", "COG", 'P', "plateAluminium", 'C', new UnificationEntry(OrePrefix.cableGtSingle, Materials.Copper), 'R', "stickAluminium", 'O', MetaItems.ELECTRIC_MOTOR_MV, 'G', new UnificationEntry(OrePrefix.gearSmall, Materials.Aluminium));
        ModHandler.addShapedRecipe("hv_piston", MetaItems.ELECTRIC_PISTON_LV.getStackForm(), "PPP", "CRR", "COG", 'P', "plateStainlessSteel", 'C', new UnificationEntry(OrePrefix.cableGtSingle, Materials.Gold), 'R', "stickStainlessSteel", 'O', MetaItems.ELECTRIC_MOTOR_HV, 'G', new UnificationEntry(OrePrefix.gearSmall, Materials.StainlessSteel));
        ModHandler.addShapedRecipe("ev_piston", MetaItems.ELECTRIC_PISTON_LV.getStackForm(), "PPP", "CRR", "COG", 'P', "plateTitanium", 'C', new UnificationEntry(OrePrefix.cableGtSingle, Materials.Aluminium), 'R', "stickTitanium", 'O', MetaItems.ELECTRIC_MOTOR_EV, 'G', new UnificationEntry(OrePrefix.gearSmall, Materials.Titanium));
        ModHandler.addShapedRecipe("iv_piston", MetaItems.ELECTRIC_PISTON_LV.getStackForm(), "PPP", "CRR", "COG", 'P', "plateTungstenSteel", 'C', new UnificationEntry(OrePrefix.cableGtSingle, Materials.Tungsten), 'R', "stickTungstenSteel", 'O', MetaItems.ELECTRIC_MOTOR_IV, 'G', new UnificationEntry(OrePrefix.gearSmall, Materials.TungstenSteel));
        ...
        ModHandler.addShapedRecipe("lv_field_generator", MetaItems.FIELD_GENERATOR_LV.getStackForm(), "WSW", "SGS", "WSW", 'W', new UnificationEntry(OrePrefix.wireGtSingle, Materials.Osmium), 'S', "circuitBasic", 'G', new UnificationEntry(OrePrefix.gem, Materials.EnderPearl));
        ModHandler.addShapedRecipe("mv_field_generator", MetaItems.FIELD_GENERATOR_MV.getStackForm(), "WSW", "SGS", "WSW", 'W', new UnificationEntry(OrePrefix.wireGtDouble, Materials.Osmium), 'S', "circuitIntermediate", 'G', new UnificationEntry(OrePrefix.gem, Materials.EnderEye));
