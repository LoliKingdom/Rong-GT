...
public class MetaItems {
    ...
    public static void init() {
        ...
        MetaMoreAutogeneratedResources third = new MetaMoreAutogeneratedResources();
    	third.setRegistryName("meta_resource_2");
        MetaAutogeneratedParts fourth = new MetaAutogeneratedParts();
        fourth.setRegistryName("meta_component");
