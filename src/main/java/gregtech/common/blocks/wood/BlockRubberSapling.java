...
public class BlockRubberSapling extends BlockBush implements IGrowable, IPlantable {
    ...
    public void generateTree(World worldIn, BlockPos pos, IBlockState state, Random rand) {
        ...
        IBlockState logState = MetaBlocks.LOG.getDefaultState()
            .withProperty(BlockRubberLog.VARIANT, LogVariant.RUBBER_WOOD)
            .withProperty(BlockRubberLog.NATURAL, true);
        IBlockState leavesState = MetaBlocks.LEAVES.getDefaultState()
            .withProperty(BlockRubberLeaves.VARIANT, LogVariant.RUBBER_WOOD);
        if(rand.nextInt(10) == 0) {
            worldgenerator = new WorldGenBigTreeCustom(true, logState, leavesState.withProperty(BlockRubberLeaves.CHECK_DECAY, false), BlockRubberLog.LOG_AXIS);
        } else {
