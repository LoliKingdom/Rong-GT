...
public class RTJEIPlugin implements IModPlugin {
	...
	public void register(IModRegistry registry) {
		...
		registry.addRecipeCatalyst(new ItemStack(RTBlocks.blockAutoclave), Values.MOD_ID + ":" + RecipeMaps.AUTOCLAVE_RECIPES.unlocalizedName);
		registry.addRecipeCatalyst(new ItemStack(RTBlocks.blockBender), Values.MOD_ID + ":" + RecipeMaps.BENDER_RECIPES.unlocalizedName);
	}
