...
public class MaterialInfoLoader {
	...
	public static void init() {
		...
		OreDictUnifier.registerOre(new ItemStack(Items.ACACIA_DOOR, 1),
				new ItemMaterialInfo(new MaterialStack(Materials.Wood, M * 2)));
		OreDictUnifier.registerOre(new ItemStack(Items.BIRCH_DOOR, 1),
				new ItemMaterialInfo(new MaterialStack(Materials.Wood, M * 2)));
		OreDictUnifier.registerOre(new ItemStack(Items.JUNGLE_DOOR, 1),
				new ItemMaterialInfo(new MaterialStack(Materials.Wood, M * 2)));
		OreDictUnifier.registerOre(new ItemStack(Items.OAK_DOOR, 1),
				new ItemMaterialInfo(new MaterialStack(Materials.Wood, M * 2)));
		OreDictUnifier.registerOre(new ItemStack(Items.SPRUCE_DOOR, 1),
				new ItemMaterialInfo(new MaterialStack(Materials.Wood, M * 2)));
		OreDictUnifier.registerOre(new ItemStack(Items.DARK_OAK_DOOR, 1),
				new ItemMaterialInfo(new MaterialStack(Materials.Wood, M * 2)));

		OreDictUnifier.registerOre(new ItemStack(Blocks.OAK_FENCE, 1),
				new ItemMaterialInfo(new MaterialStack(Materials.Wood, EnumOrePrefix.dustTiny.materialAmount * 15)));
		OreDictUnifier.registerOre(new ItemStack(Blocks.BIRCH_FENCE, 1),
				new ItemMaterialInfo(new MaterialStack(Materials.Wood, EnumOrePrefix.dustTiny.materialAmount * 15)));
		OreDictUnifier.registerOre(new ItemStack(Blocks.SPRUCE_FENCE, 1),
				new ItemMaterialInfo(new MaterialStack(Materials.Wood, EnumOrePrefix.dustTiny.materialAmount * 15)));
		OreDictUnifier.registerOre(new ItemStack(Blocks.JUNGLE_FENCE, 1),
				new ItemMaterialInfo(new MaterialStack(Materials.Wood, EnumOrePrefix.dustTiny.materialAmount * 15)));
		OreDictUnifier.registerOre(new ItemStack(Blocks.DARK_OAK_FENCE, 1),
				new ItemMaterialInfo(new MaterialStack(Materials.Wood, EnumOrePrefix.dustTiny.materialAmount * 15)));
		OreDictUnifier.registerOre(new ItemStack(Blocks.ACACIA_FENCE, 1),
				new ItemMaterialInfo(new MaterialStack(Materials.Wood, EnumOrePrefix.dustTiny.materialAmount * 15)));

		OreDictUnifier.registerOre(new ItemStack(Blocks.OAK_FENCE_GATE, 1),
				new ItemMaterialInfo(new MaterialStack(Materials.Wood, EnumOrePrefix.dust.materialAmount * 4)));
		OreDictUnifier.registerOre(new ItemStack(Blocks.BIRCH_FENCE_GATE, 1),
				new ItemMaterialInfo(new MaterialStack(Materials.Wood, EnumOrePrefix.dust.materialAmount * 4)));
		OreDictUnifier.registerOre(new ItemStack(Blocks.SPRUCE_FENCE_GATE, 1),
				new ItemMaterialInfo(new MaterialStack(Materials.Wood, EnumOrePrefix.dust.materialAmount * 4)));
		OreDictUnifier.registerOre(new ItemStack(Blocks.JUNGLE_FENCE_GATE, 1),
				new ItemMaterialInfo(new MaterialStack(Materials.Wood, EnumOrePrefix.dust.materialAmount * 4)));
		OreDictUnifier.registerOre(new ItemStack(Blocks.DARK_OAK_FENCE_GATE, 1),
				new ItemMaterialInfo(new MaterialStack(Materials.Wood, EnumOrePrefix.dust.materialAmount * 4)));
		OreDictUnifier.registerOre(new ItemStack(Blocks.ACACIA_FENCE_GATE, 1),
				new ItemMaterialInfo(new MaterialStack(Materials.Wood, EnumOrePrefix.dust.materialAmount * 4)));

		OreDictUnifier.registerOre(new ItemStack(Blocks.OAK_STAIRS, 1),
				new ItemMaterialInfo(new MaterialStack(Materials.Wood, EnumOrePrefix.dustTiny.materialAmount * 24)));
		OreDictUnifier.registerOre(new ItemStack(Blocks.BIRCH_STAIRS, 1),
				new ItemMaterialInfo(new MaterialStack(Materials.Wood, EnumOrePrefix.dustTiny.materialAmount * 24)));
		OreDictUnifier.registerOre(new ItemStack(Blocks.SPRUCE_STAIRS, 1),
				new ItemMaterialInfo(new MaterialStack(Materials.Wood, EnumOrePrefix.dustTiny.materialAmount * 24)));
		OreDictUnifier.registerOre(new ItemStack(Blocks.JUNGLE_STAIRS, 1),
				new ItemMaterialInfo(new MaterialStack(Materials.Wood, EnumOrePrefix.dustTiny.materialAmount * 24)));
		OreDictUnifier.registerOre(new ItemStack(Blocks.DARK_OAK_STAIRS, 1),
				new ItemMaterialInfo(new MaterialStack(Materials.Wood, EnumOrePrefix.dustTiny.materialAmount * 24)));
		OreDictUnifier.registerOre(new ItemStack(Blocks.ACACIA_STAIRS, 1),
				new ItemMaterialInfo(new MaterialStack(Materials.Wood, EnumOrePrefix.dustTiny.materialAmount * 24)));

		OreDictUnifier.registerOre(new ItemStack(Blocks.STONE_STAIRS, 1),
				new ItemMaterialInfo(new MaterialStack(Materials.Stone, EnumOrePrefix.dustTiny.materialAmount * 24)));
		...
		OreDictUnifier.registerOre(new ItemStack(Blocks.QUARTZ_STAIRS, 1),
				new ItemMaterialInfo(new MaterialStack(Materials.NetherQuartz, EnumOrePrefix.dust.materialAmount * 6)));
		OreDictUnifier.registerOre(new ItemStack(Blocks.BRICK_STAIRS, 1),
				new ItemMaterialInfo(new MaterialStack(Materials.Brick, EnumOrePrefix.dust.materialAmount * 6)));
		OreDictUnifier.registerOre(new ItemStack(Blocks.NETHER_BRICK_STAIRS, 1),
				new ItemMaterialInfo(new MaterialStack(Materials.Netherrack, EnumOrePrefix.dust.materialAmount * 6)));
		...
		OreDictUnifier.registerOre(new ItemStack(Blocks.WOODEN_SLAB, 1, W),
				new ItemMaterialInfo(new MaterialStack(Materials.Wood, M / 2)));

		OreDictUnifier.registerOre(new ItemStack(Blocks.LEVER, 1, W), new ItemMaterialInfo(
				new MaterialStack(Materials.Stone, M), new MaterialStack(Materials.Wood, 1814400L)));
		...
		OreDictUnifier.registerOre(new ItemStack(Blocks.ICE, 1, W),
				new ItemMaterialInfo(new MaterialStack(Materials.Ice, M)));
		...
		OreDictUnifier.registerOre(new ItemStack(Items.WRITTEN_BOOK, 1, W),
				new ItemMaterialInfo(new MaterialStack(Materials.Paper, M * 3)));
		...
		OreDictUnifier.registerOre(new ItemStack(Items.GOLDEN_APPLE, 1, 1),
				new ItemMaterialInfo(new MaterialStack(Materials.Gold, EnumOrePrefix.block.materialAmount * 8L)));
		OreDictUnifier.registerOre(new ItemStack(Items.GOLDEN_APPLE, 1, 0),
				new ItemMaterialInfo(new MaterialStack(Materials.Gold, EnumOrePrefix.ingot.materialAmount * 8L)));
		OreDictUnifier.registerOre(new ItemStack(Items.SPECKLED_MELON, 1, 0),
				new ItemMaterialInfo(new MaterialStack(Materials.Gold, EnumOrePrefix.nugget.materialAmount * 8L)));
		...
		OreDictUnifier.registerOre(new ItemStack(Blocks.STAINED_GLASS_PANE, 1, W),
				new ItemMaterialInfo(new MaterialStack(Materials.Glass, 1360800L)));
		...
		OreDictUnifier.registerOre(new ItemStack(Blocks.TRAPPED_CHEST, 1, W),
				new ItemMaterialInfo(new MaterialStack(Materials.Wood, M * 8),
						new MaterialStack(Materials.Iron, EnumOrePrefix.ring.materialAmount * 2L)));

		OreDictUnifier.registerOre(new ItemStack(Blocks.REDSTONE_LAMP, 1, W),
				new ItemMaterialInfo(new MaterialStack(Materials.Glowstone, M * 4),
						new MaterialStack(Materials.Redstone, EnumOrePrefix.dust.materialAmount * 4L)));
		...
		OreDictUnifier.registerOre(new ItemStack(Blocks.DISPENSER, 1, W), new ItemMaterialInfo(
				new MaterialStack(Materials.Stone, M * 7), new MaterialStack(Materials.Redstone, M)));
		...
		/*for(CoilType coilType : CoilType.values()) {
			if(coilType.getMaterial() instanceof DustMaterial) {
				...
				OreDictUnifier.registerOre(outputStack, new ItemMaterialInfo(
						new MaterialStack(coilType.getMaterial(), EnumOrePrefix.wireGtDouble.materialAmount * 8)));
			}
		}*/
	}
}