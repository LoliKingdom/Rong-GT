package com.rong.rt.common.blocks.renders;
...
public class StoneRenderer implements ICCBlockRenderer {
	...
	private void lazyInitializeRenderers() {
		if(waterRenderer == null) {
			...
			this.waterRenderer = ObfuscationReflectionHelper.getPrivateValue(BlockRendererDispatcher.class, dispatcher,
					3); // fluidRenderer
		}
	}
	...
	public boolean renderBlock(IBlockAccess world, BlockPos pos, IBlockState state, BufferBuilder buffer) {
		...
		operations[0] = new ColourMultiplier(
				Utility.convertRGBtoOpaqueRGBA_CL(blockColors.colorMultiplier(state, world, pos, 1)));
		if(world != null) {
