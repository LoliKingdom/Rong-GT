...
import static com.rong.rt.api.unification.materials.types.IngotMaterial.MatFlags.GENERATE_DENSE;
import static com.rong.rt.api.unification.materials.types.IngotMaterial.MatFlags.GENERATE_FINE_WIRE;
import static com.rong.rt.api.unification.materials.types.IngotMaterial.MatFlags.GENERATE_FOIL;
import static com.rong.rt.api.unification.materials.types.IngotMaterial.MatFlags.GENERATE_RING;
import static com.rong.rt.api.unification.materials.types.IngotMaterial.MatFlags.GENERATE_ROTOR;
import static com.rong.rt.api.unification.materials.types.IngotMaterial.MatFlags.GENERATE_SCREW;
import static com.rong.rt.api.unification.materials.types.IngotMaterial.MatFlags.GENERATE_SMALL_GEAR;
...
public class IngotMaterial extends SolidMaterial {
	...
	public static final class MatFlags {
		...
		/**
		 * Add this to your Material if you want to have its Ore Calcite heated in a
		 * Blast Furnace for more output. Already listed are: Iron, Pyrite, PigIron,
		 * WroughtIron.
		 */
	...
	/**
	 * Specifies a material into which this material parts turn when processed in
	 * the recycler
	 */
	...
	/**
	 * Blast furnace temperature of this material Equal to zero if material doesn't
	 * use blast furnace If below 1000C, primitive blast furnace recipes will be
	 * also added
	 */
	public final int blastFurnaceTemperature;

	public IngotMaterial(int metaItemSubId, String name, int materialRGB, MaterialIconSet materialIconSet,
			int harvestLevel, ImmutableList<MaterialStack> materialComponents, long materialGenerationFlags,
			EnumElements element, float toolSpeed, float attackDamage, int toolDurability,
			int blastFurnaceTemperature) {
		super(metaItemSubId, name, materialRGB, materialIconSet, harvestLevel, materialComponents,
				materialGenerationFlags, element, toolSpeed, attackDamage, toolDurability);
	...
	public IngotMaterial(int metaItemSubId, String name, int materialRGB, MaterialIconSet materialIconSet,
		...
		this(metaItemSubId, name, materialRGB, materialIconSet, harvestLevel, materialComponents,
				materialGenerationFlags, element, 0, 0, 0, 0);
	}

	public IngotMaterial(int metaItemSubId, String name, int materialRGB, MaterialIconSet materialIconSet,
			int harvestLevel, ImmutableList<MaterialStack> materialComponents, long materialGenerationFlags,
			EnumElements element, int blastFurnaceTemperature) {
		this(metaItemSubId, name, materialRGB, materialIconSet, harvestLevel, materialComponents,
				materialGenerationFlags, element, 0, 0, 0, blastFurnaceTemperature);
	}
	...
	public IngotMaterial(int metaItemSubId, String name, int materialRGB, MaterialIconSet materialIconSet,
			...
			EnumElements element, float toolSpeed, float attackDamage, int toolDurability) {
		this(metaItemSubId, name, materialRGB, materialIconSet, harvestLevel, materialComponents,
				materialGenerationFlags, element, toolSpeed, attackDamage, toolDurability, 0);
	}

	public IngotMaterial(int metaItemSubId, String name, int materialRGB, MaterialIconSet materialIconSet,
			int harvestLevel, ImmutableList<MaterialStack> materialComponents, long materialGenerationFlags,
			float toolSpeed, float attackDamage, int toolDurability) {
		this(metaItemSubId, name, materialRGB, materialIconSet, harvestLevel, materialComponents,
				materialGenerationFlags, null, toolSpeed, attackDamage, toolDurability, 0);
	}

	public IngotMaterial(int metaItemSubId, String name, int materialRGB, MaterialIconSet materialIconSet,
			int harvestLevel, ImmutableList<MaterialStack> materialComponents, long materialGenerationFlags) {
		this(metaItemSubId, name, materialRGB, materialIconSet, harvestLevel, materialComponents,
				materialGenerationFlags, null, 0, 0, 0, 0);
	}
