...
import com.rong.rt.api.unification.materials.IMaterialHandler;
...
@ZenClass("mods.rongtech.material.Material")
@ZenRegister
public abstract class Material implements Comparable<Material> {

    public static final ControlledRegistry<String, Material> MATERIAL_REGISTRY = new ControlledRegistry<>(1000);
    ...
    public static void freezeRegistry() {
    	RTLog.logger.info("Freezing material registry...");
     ...
     */
    @ZenProperty
    public final EnumElements element;
    
    /**
     * NuclearCraft purposes.
     */
    @ZenProperty
    public int radioactivity = 0;
    ...
    public Material(int metaItemSubId, String name, int materialRGB, MaterialIconSet materialIconSet, ImmutableList<MaterialStack> materialComponents, long materialGenerationFlags, EnumElements element) {
    ...
    public long getProtons() {
        ...
        if (materialComponents.isEmpty())
            return EnumElements.Tc.getProtons();
        long totalProtons = 0;
        for (MaterialStack material : materialComponents) {
    ...
    public long getNeutrons() {
        ...
        if (materialComponents.isEmpty())
            return EnumElements.Tc.getNeutrons();
    ...
    public long getMass() {
        ...
        if (materialComponents.isEmpty())
            return EnumElements.Tc.getMass();
        long totalMass = 0;
        for (MaterialStack material : materialComponents) {
