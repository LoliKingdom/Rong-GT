 ...
 */
@ZenClass("mods.rongtech.material.EnumElements")
@ZenRegister
public enum EnumElements {
     ...
     */
    EnumElements(long protons, long neutrons, long halfLifeSeconds, String decayTo, String name, boolean isIsotope) {
    ...
    @ZenMethod
    public static EnumElements get(String materialName) {
        try {
            return EnumElements.valueOf(materialName);
        } 
