...
public abstract class AbstractBakedModel implements IBakedModel {
	...
	protected void putVertex(UnpackedBakedQuad.Builder builder, Vec3d normal, TextureAtlasSprite sprite, double x,
			double y, double z, float u, float v, int rgbaColor) {
	...
	protected BakedQuad createQuad(Vec3d v1, Vec3d v2, Vec3d v3, Vec3d v4, TextureAtlasSprite sprite,
			EnumFacing orientation, int rgbaColor) {
