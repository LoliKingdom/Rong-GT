...
import com.rong.rt.api.DamageSources;
...
public class MaterialMetaItem extends StandardMetaItem {
    ...
    protected EnumOrePrefix[] prefixes;
    ...
    public void registerOreDict() {
        for(short metaItem : generatedItems) {
            EnumOrePrefix prefix = this.prefixes[metaItem / 1000];
    ...
    public String getItemStackDisplayName(ItemStack itemStack) {
        if(itemStack.getItemDamage() < metaItemOffset) {
            ...
            EnumOrePrefix prefix = prefixes[itemStack.getItemDamage() / 1000];
    ...
    public int getItemStackLimit(ItemStack stack) {
        if(stack.getItemDamage() < metaItemOffset) {
            EnumOrePrefix prefix = prefixes[stack.getItemDamage() / 1000];
    ...
    public EnumOrePrefix getEnumOrePrefix(ItemStack itemStack) {
        int damage = itemStack.getItemDamage();
        if (damage < this.metaItemOffset) {
            return this.prefixes[(damage / 1000)];
        }
        return null;
    }
