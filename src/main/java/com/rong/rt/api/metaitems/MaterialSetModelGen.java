...
public class MaterialSetModelGen {
    ...
    public static void main(String[] args) throws Exception {
        File rongtechRoot = new File("src/main/resources/assets/rongtech");
        File modelsRoot = new File(rongtechRoot, "models/item/material_sets");
        File texturesRoot = new File(rongtechRoot, "textures/items/material_sets");
        modelsRoot.mkdirs();
            ...
            if(file.isDirectory()) {
                ...
                for(File child : file.listFiles()) {
                    ...
                    if(name.endsWith(".png") && !name.endsWith("_overlay.png")) {
                        ...
                        String texturePath = "rongtech:items/material_sets/" + file.getName() + "/" + name;
