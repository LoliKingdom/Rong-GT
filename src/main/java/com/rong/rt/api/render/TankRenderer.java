...
public class TankRenderer implements IIconRegister {
    ...
    public void registerIcons(TextureMap textureMap) {
        this.sideSprite = textureMap.registerSprite(new ResourceLocation(Values.MOD_ID, "blocks/" + basePath));
    }
    ...
    public void render(CCRenderState renderState, Matrix4 translation, int baseColor, IVertexOperation[] pipeline, int capacity, FluidStack fluidStack) {
        ...
        if (fluidStack != null) {
            ...
            ColourMultiplier multiplier = new ColourMultiplier(Utility.convertRGBtoOpaqueRGBA_CL(fluidStack.getFluid().getColor(fluidStack)));
