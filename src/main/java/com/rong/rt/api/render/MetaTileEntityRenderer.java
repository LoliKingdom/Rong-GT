...
import com.rong.rt.api.block.machines.MachineItemBlock;
import com.rong.rt.api.metatileentity.IFastRenderMetaTileEntity;
import com.rong.rt.api.metatileentity.IRenderMetaTileEntity;
...
public class MetaTileEntityRenderer implements ICCBlockRenderer, IItemRenderer {
	...
	public static ModelResourceLocation MODEL_LOCATION = new ModelResourceLocation(
			new ResourceLocation(Values.MOD_ID, "machine"), "normal");
	...
	public static void postInit() {
		try {
			...
			try(IResource resource = Minecraft.getMinecraft().getResourceManager()
					.getResource(new ResourceLocation("models/block/block.json"))) {
			...
			RTLog.logger.error("Failed to load default block transforms", exception);
		}
	}

	@SubscribeEvent
	public void onModelsBake(ModelBakeEvent event) {
		RTLog.logger.info("Injected MetaTileEntity render model");
