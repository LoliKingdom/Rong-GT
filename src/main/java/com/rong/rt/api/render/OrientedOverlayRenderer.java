...
public class OrientedOverlayRenderer implements IIconRegister {
    ...
    public void registerIcons(TextureMap textureMap) {
        ...
        for (OverlayFace overlayFace : faces) {
            ...
            ResourceLocation normalLocation = new ResourceLocation(Values.MOD_ID, String.format("blocks/%s/overlay_%s", basePath, faceName));
            ResourceLocation activeLocation = new ResourceLocation(Values.MOD_ID, String.format("blocks/%s/overlay_%s_active", basePath, faceName));
