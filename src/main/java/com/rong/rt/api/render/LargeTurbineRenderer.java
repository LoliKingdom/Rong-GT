package com.rong.rt.api.render;
...
public class LargeTurbineRenderer implements IIconRegister {
    ...
    public void registerIcons(TextureMap textureMap) {
        this.baseRingSprite = textureMap.registerSprite(new ResourceLocation(Values.MOD_ID, "blocks/multiblock/large_turbine/base_ring"));
        this.baseBackgroundSprite = textureMap.registerSprite(new ResourceLocation(Values.MOD_ID, "blocks/multiblock/large_turbine/base_bg"));
        this.idleBladeSprite = textureMap.registerSprite(new ResourceLocation(Values.MOD_ID, "blocks/multiblock/large_turbine/rotor_idle"));
        this.activeBladeSprite = textureMap.registerSprite(new ResourceLocation(Values.MOD_ID, "blocks/multiblock/large_turbine/rotor_spinning"));
    }
    ...
    public void renderSided(CCRenderState renderState, Matrix4 translation, IVertexOperation[] pipeline, EnumFacing side, boolean hasBase, boolean hasRotor, boolean isActive, int rotorRGB) {
        ...
        if (hasRotor) {
            ...
            IVertexOperation[] color = ArrayUtils.add(pipeline, new ColourMultiplier(Utility.convertRGBtoOpaqueRGBA_CL(rotorRGB)));
