...
import com.rong.rt.api.gui.resources.RenderUtil;
    ...
    public void drawInForeground(int mouseX, int mouseY) {
        if (!hideTooltip && !gui.isJEIHandled && isMouseOver(xPosition, yPosition, width, height, mouseX, mouseY)) {
            ...
            if (lastFluidInTank != null) {
                ...
                tooltips.add(I18n.format("rongtech.fluid.amount", lastFluidInTank.amount, lastTankCapacity));
                tooltips.add(I18n.format("rongtech.fluid.temperature", fluid.getTemperature(lastFluidInTank)));
                tooltips.add(I18n.format(fluid.isGaseous(lastFluidInTank) ? "rongtech.fluid.state_gas" : "rongtech.fluid.state_liquid"));
            } else {
                tooltips.add(I18n.format("rongtech.fluid.empty"));
                tooltips.add(I18n.format("rongtech.fluid.amount", 0, lastTankCapacity));
            }
            if (allowClickFilling) {
                tooltips.add(""); //add empty line to separate things
                tooltips.add(I18n.format("rongtech.fluid.click_to_fill"));
                tooltips.add(I18n.format("rongtech.fluid.click_to_fill.shift"));
            }
            if (allowClickEmptying) {
                tooltips.add(""); //add empty line to separate things
                tooltips.add(I18n.format("rongtech.fluid.click_to_empty"));
                tooltips.add(I18n.format("rongtech.fluid.click_to_empty.shift"));
            }
