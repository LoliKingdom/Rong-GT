...
public class Utility {
	...
	/**
	 * @return a list of fluidstack linked with given fluid handler modifications in
	 *         list will reflect on fluid handler and wise-versa
	 */
	...
	public static void doOvervoltageExplosion(MetaTileEntity metaTileEntity, long voltage) {
		...
		if(!metaTileEntity.getWorld().isRemote) {
			...
			((WorldServer) metaTileEntity.getWorld()).spawnParticle(EnumParticleTypes.SMOKE_LARGE, posX, posY, posZ, 10,
					0.2, 0.2, 0.2, 0.0);

			if(ConfigHolder.doExplosions) {
				metaTileEntity.getWorld().createExplosion(null, posX, posY, posZ, getTierByVoltage(voltage), true);
			}
		}
	}
