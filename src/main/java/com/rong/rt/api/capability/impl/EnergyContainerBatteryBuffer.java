...
public class EnergyContainerBatteryBuffer extends MTETrait implements IEnergyContainer {
    ...
    public void update() {
        if(!metaTileEntity.getWorld().isRemote) {
            ...
            IEnergyContainer energyContainer = tileEntity.getCapability(RTCapabilities.CAPABILITY_ENERGY_CONTAINER, outFacing.getOpposite());
    ...
    public IElectricItem getBatteryContainer(ItemStack itemStack) {
        IElectricItem electricItem = itemStack.getCapability(RTCapabilities.CAPABILITY_ELECTRIC_ITEM, null);
