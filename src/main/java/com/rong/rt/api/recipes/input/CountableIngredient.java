...
public class CountableIngredient {
	...
	public static CountableIngredient from(EnumOrePrefix prefix, Material material) {
		return from(prefix, material, 1);
	}

	public static CountableIngredient from(EnumOrePrefix prefix, Material material, int count) {
	...
	public boolean equals(Object o) {
		...
		return count == that.count && Objects.equals(ingredient, that.ingredient);
	}
	...
	public String toString() {
		return "CountableIngredient{" + "ingredient=" + Arrays.toString(ingredient.getMatchingStacks()) + ", count="
				+ count + '}';
	}
