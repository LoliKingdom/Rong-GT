...
import com.rong.rt.api.gui.widgets.AdvancedTextWidget;
...
public abstract class MultiblockWithDisplayBase extends MultiblockControllerBase {
	...
	/**
	 * Called serverside to obtain text displayed in GUI each element of list is
	 * displayed on new line to use translation, use TextComponentTranslation
	 */
	...
	protected ModularUI.Builder createUITemplate(EntityPlayer entityPlayer) {
		...
		builder.widget(new AdvancedTextWidget(10, 17, this::addDisplayText, 0xFFFFFF).setMaxWidthLimit(156));
