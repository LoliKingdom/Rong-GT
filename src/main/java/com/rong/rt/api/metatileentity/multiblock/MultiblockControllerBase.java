package com.rong.rt.api.metatileentity.multiblock;
...
import com.rong.rt.api.multiblock.BlockPattern;
import com.rong.rt.api.multiblock.BlockWorldState;
import com.rong.rt.api.multiblock.IPatternCenterPredicate;
import com.rong.rt.api.multiblock.PatternMatchContext;
import com.rong.rt.api.render.ICubeRenderer;
...
public abstract class MultiblockControllerBase extends MetaTileEntity {
    ...
    public void renderMetaTileEntity(CCRenderState renderState, Matrix4 translation, IVertexOperation[] pipeline) {
        getBaseTexture(null).render(renderState, translation, ArrayUtils.add(pipeline, new ColourMultiplier(Utility.convertRGBtoOpaqueRGBA_CL(getPaintingColorForRendering()))));
    }
