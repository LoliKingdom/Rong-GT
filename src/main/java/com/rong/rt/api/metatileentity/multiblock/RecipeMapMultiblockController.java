...
import com.rong.rt.api.capability.impl.EnergyContainerList;
import com.rong.rt.api.capability.impl.MultiblockRecipeLogic;
...
import com.rong.rt.api.recipes.handlers.ItemHandlerList;
    ...
    protected void addDisplayText(List<ITextComponent> textList) {
        ...
        if (isStructureFormed()) {
            ...
            if(energyContainer != null && energyContainer.getEnergyCapacity() > 0) {
                ...
                String voltageName = Values.VN[Utility.getTierByVoltage(maxVoltage)];
