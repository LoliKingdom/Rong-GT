...
public class MetaTileEntityHolder extends TickableTileEntityBase implements IUIHolder {
    ...
    public MetaTileEntity setMetaTileEntity(MetaTileEntity sampleMetaTileEntity) {
        ...
        if (hasWorld() && !getWorld().isRemote) {
            ...
            writeCustomData(-1, buffer -> {
                buffer.writeVarInt(RongTechAPI.META_TILE_ENTITY_REGISTRY.getIdByObjectName(metaTileEntity.metaTileEntityId));
    ...
    public void readFromNBT(NBTTagCompound compound) {
        ...
        if (compound.hasKey("MetaId", NBT.TAG_STRING)) {
            ...
            MetaTileEntity sampleMetaTileEntity = metaTileEntityId == null ? null : RongTechAPI.META_TILE_ENTITY_REGISTRY.getObject(metaTileEntityId);
            ...
            if (sampleMetaTileEntity != null) {
                ...
                RTLog.logger.error("Failed to load MetaTileEntity with invalid ID " + metaTileEntityIdRaw);
            }
        }
    }
    ...
    private static ResourceLocation convertMetaTileEntityId(String metaTileEntityIdOld) {
        ResourceLocation gregtechId = new ResourceLocation(Values.MOD_ID, metaTileEntityIdOld);
        ControlledRegistry<ResourceLocation, MetaTileEntity> registry = RongTechAPI.META_TILE_ENTITY_REGISTRY;
        ...
        if (registeredModIDs == null) {
            ...
            registeredModIDs.remove(Values.MOD_ID);
        }
        ...
        RTLog.logger.error("Failed to convert old MetaTileEntity string ID " + metaTileEntityIdOld);
        return null;
    }
    ...
    public void writeInitialSyncData(PacketBuffer buf) {
        if (metaTileEntity != null) {
            ...
            buf.writeVarInt(RongTechAPI.META_TILE_ENTITY_REGISTRY.getIdByObjectName(metaTileEntity.metaTileEntityId));
    ...
    public void receiveInitialSyncData(PacketBuffer buf) {
        if (buf.readBoolean()) {
            ...
            setMetaTileEntity(RongTechAPI.META_TILE_ENTITY_REGISTRY.getObjectById(metaTileEntityId));
