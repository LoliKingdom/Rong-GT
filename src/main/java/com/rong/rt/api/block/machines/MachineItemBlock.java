...
import com.rong.rt.api.metatileentity.ITieredMetaTileEntity;
...
public class MachineItemBlock extends ItemBlock {
    ...
    public static MetaTileEntity getMetaTileEntity(ItemStack itemStack) {
        return RongTechAPI.META_TILE_ENTITY_REGISTRY.getObjectById(itemStack.getItemDamage());
    }
    ...
    public void addInformation(ItemStack stack, @Nullable World worldIn, List<String> tooltip, ITooltipFlag flagIn) {
        ...
        if(!metaTileEntityId.getResourceDomain().equals(Values.MOD_ID)) {
