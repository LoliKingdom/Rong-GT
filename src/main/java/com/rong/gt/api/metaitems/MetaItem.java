...
import com.rong.gt.api.capabilities.CombinedCapabilityProvider;
import com.rong.gt.api.gui.resources.RenderUtil;
import com.rong.gt.api.metaitems.interfaces.IFoodBehavior;
import com.rong.gt.api.metaitems.interfaces.IItemBehaviour;
import com.rong.gt.api.metaitems.interfaces.IItemCapabilityProvider;
import com.rong.gt.api.metaitems.interfaces.IItemColorProvider;
import com.rong.gt.api.metaitems.interfaces.IItemContainerItemProvider;
import com.rong.gt.api.metaitems.interfaces.IItemDurabilityManager;
import com.rong.gt.api.metaitems.interfaces.IItemMaxStackSizeProvider;
import com.rong.gt.api.metaitems.interfaces.IItemModelIndexProvider;
import com.rong.gt.api.metaitems.interfaces.IItemNameProvider;
import com.rong.gt.api.metaitems.interfaces.IItemUseManager;
import com.rong.gt.api.metaitems.interfaces.IMetaItemStats;
...
public abstract class MetaItem<T extends MetaItem<?>.MetaValueItem> extends Item {
        ...
        for(short itemMetaKey : metaItems.keys()) {
            ...
            if (numberOfModels > 1) {
                ...
                for (int i = 0; i < resourceLocations.length; i++) {
                    ResourceLocation resourceLocation = new ResourceLocation(Values.MOD_ID, formatModelPath(metaValueItem) + "/" + (i + 1));
    ...
    public void getSubItems(CreativeTabs tab, NonNullList<ItemStack> subItems) {
        if(tab != RongTechAPI.TAB_RT_MAIN && tab != CreativeTabs.SEARCH)
            return;
