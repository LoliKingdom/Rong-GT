package com.rong.gt.api.gui.resources;
...
public class SizedTextureArea extends TextureArea {
    ...
    public static SizedTextureArea fullImage(String imageLocation, int imageWidth, int imageHeight) {
        return new SizedTextureArea(new ResourceLocation(Values.MOD_ID, imageLocation), 0.0, 0.0, 1.0, 1.0, imageWidth, imageHeight);
    }
