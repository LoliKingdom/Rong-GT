package com.rong.gt.api.gui.impl;
...
import com.rong.gt.api.gui.INativeWidget;
import com.rong.gt.api.gui.ModularUI;
import com.rong.gt.api.gui.Widget;
import com.rong.gt.api.gui.widgets.WidgetUIAccess;
import com.rong.gt.api.net.NetworkHandler;
import com.rong.gt.api.net.PacketUIClientAction;
...
public class ModularUIContainer extends Container implements WidgetUIAccess {
    ...
    public ItemStack transferStackInSlot(EntityPlayer player, int index) {
        ...
        if(slotMap.get(slot).getSlotLocationInfo().isPlayerInventory) {
            ...
            mergedStack = Utility.mergeItemStack(remainingStack, containerSlots);
        } else {
            ...
            List<Slot> inventorySlots = slotMap.entrySet().stream()
                ...
                .collect(Collectors.toList());
            mergedStack = Utility.mergeItemStack(remainingStack, inventorySlots);
        }
        if(!mergedStack) {
