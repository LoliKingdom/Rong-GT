...
import com.rong.gt.api.unification.materials.MaterialIconType;
import com.rong.gt.api.unification.materials.Materials;
import com.rong.gt.api.unification.materials.types.DustMaterial;
import com.rong.gt.api.unification.materials.types.GemMaterial;
...
import com.rong.gt.api.unification.materials.types.SolidMaterial;
import com.rong.gt.api.unification.materials.MarkerMaterials;
...
import static com.rong.gt.api.unification.EnumOrePrefix.Flags.*;
import static com.rong.gt.api.unification.EnumOrePrefix.Conditions.isToolMaterial;
import static com.rong.gt.api.unification.materials.types.DustMaterial.MatFlags.*;
import static com.rong.gt.api.unification.materials.types.IngotMaterial.MatFlags.*;
import static com.rong.gt.api.unification.materials.types.SolidMaterial.MatFlags.*;
import static com.rong.gt.api.unification.materials.types.GemMaterial.MatFlags.*;
...
public enum EnumOrePrefix {
    ...
    public static class Flags {
        public static final long ENABLE_UNIFICATION = Utility.createFlag(0);
        public static final long SELF_REFERENCING = Utility.createFlag(1);
        public static final long FLUID_CONTAINER = Utility.createFlag(2);
        public static final long DISALLOW_RECYCLING = Utility.createFlag(3);
    }
    ...
    EnumOrePrefix(String categoryName, long materialAmount, Material material, MaterialIconType materialIconType, long flags, Predicate<Material> condition) {
    ...
    public static EnumOrePrefix getPrefix(String prefixName) {
        return getPrefix(prefixName, null);
    }

    public static EnumOrePrefix getPrefix(String prefixName, @Nullable EnumOrePrefix replacement) {
        try {
            return Enum.valueOf(EnumOrePrefix.class, prefixName);
    ...
    public <T extends Material> void addProcessingHandler(Class<T> materialFilter, BiConsumer<EnumOrePrefix, T> handler) {
    ...
    public static void runMaterialHandlers() {
        for(EnumOrePrefix orePrefix : values()) {
            orePrefix.runGeneratedMaterialHandlers();
        }
    }

    private static final ThreadLocal<EnumOrePrefix> currentProcessingPrefix = new ThreadLocal<>();
    private static final ThreadLocal<Material> currentMaterial = new ThreadLocal<>();

    public static EnumOrePrefix getCurrentProcessingPrefix() {
