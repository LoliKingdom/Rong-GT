...
public abstract class SolidMaterial extends DustMaterial {
    ...
    public SolidMaterial(int metaItemSubId, String name, int materialRGB, MaterialIconSet materialIconSet, int harvestLevel, ImmutableList<MaterialStack> materialComponents, long materialGenerationFlags, EnumElements element, float toolSpeed, float toolAttackDamage, int toolDurability) {
