...
public class NetworkHandler {
    ...
    public static void init() {
        channel = NetworkRegistry.INSTANCE.newEventDrivenChannel(Values.MOD_ID);
    ...
    private static void initClient() {
        registerClientExecutor(PacketUIOpen.class, (packet, handler) -> {
            ...
            if (uiFactory == null) {
                RTLog.logger.warn("Couldn't find UI Factory with id '{}'", packet.uiFactoryId);
            } else {
    ...
    public static FMLProxyPacket packet2proxy(Packet packet) {
        ...
        return new FMLProxyPacket(buf, Values.MOD_ID);
    }
