...
import static com.rong.gt.api.render.OrientedOverlayRenderer.OverlayFace.*;
...
public class Textures {
    ...
    public static SimpleSidedCubeRenderer[] VOLTAGE_CASINGS = new SimpleSidedCubeRenderer[Values.V.length];
    ...
    static {
        for (int i = 0; i < VOLTAGE_CASINGS.length; i++) {
            String voltageName = Values.VN[i].toLowerCase();
    ...
    public static void register(TextureMap textureMap) {
        RTLog.logger.info("Loading te texture sprites...");
